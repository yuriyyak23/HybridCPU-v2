...
public static class CompilerMatrixTilePositiveEmissionAbiContract
{
        ...
        DataTypeEnum elementType)
    {
        MatrixTileNumericProfileId profileId = elementType switch
        {
            ...
            DataTypeEnum.FLOAT32 => MatrixTileNumericProfileId.Binary32ToBinary32,
            DataTypeEnum.FLOAT64 => MatrixTileNumericProfileId.Binary64ToBinary64,
    ...
    public static MatrixTileNumericPolicy CreateRuntimeNumericPolicy(
        ...
        MatrixTileNumericElementKind elementKind)
    {
        DataTypeEnum elementType = (elementKind, elementSizeBytes) switch
        {
            (MatrixTileNumericElementKind.SignedInteger, 1) => DataTypeEnum.INT8,
            (MatrixTileNumericElementKind.SignedInteger, 2) => DataTypeEnum.INT16,
            (MatrixTileNumericElementKind.SignedInteger, 4) => DataTypeEnum.INT32,
            (MatrixTileNumericElementKind.SignedInteger, 8) => DataTypeEnum.INT64,
            (MatrixTileNumericElementKind.UnsignedInteger, 1) => DataTypeEnum.UINT8,
            (MatrixTileNumericElementKind.UnsignedInteger, 2) => DataTypeEnum.UINT16,
            (MatrixTileNumericElementKind.UnsignedInteger, 4) => DataTypeEnum.UINT32,
            (MatrixTileNumericElementKind.UnsignedInteger, 8) => DataTypeEnum.UINT64,
            (MatrixTileNumericElementKind.FloatingPoint, 4) => DataTypeEnum.FLOAT32,
            (MatrixTileNumericElementKind.FloatingPoint, 8) => DataTypeEnum.FLOAT64,
