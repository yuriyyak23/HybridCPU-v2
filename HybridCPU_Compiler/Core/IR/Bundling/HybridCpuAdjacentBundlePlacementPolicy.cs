...
{
    /// <summary>
    /// Deterministic Stage 6 placement policy for adjacent-bundle pair search without rescheduling.
    /// </summary>
    internal static class HybridCpuAdjacentBundlePlacementPolicy
    {
        public static bool Dominates(IrAdjacentBundlePlacementCandidate candidate, IrAdjacentBundlePlacementCandidate other)
        {
            ...
            return CompareAssignedSlots(candidate.FirstInstructionSlots, other.FirstInstructionSlots) < 0
                || (CompareAssignedSlots(candidate.FirstInstructionSlots, other.FirstInstructionSlots) == 0
                    && CompareAssignedSlots(candidate.SecondInstructionSlots, other.SecondInstructionSlots) < 0);
        }

        public static bool IsBetterPlacement(
            IrAdjacentBundlePlacementCandidate candidate,
            IrAdjacentBundlePlacementCandidate current,
            HybridCpuBackendPlacementTieBreakContext tieBreakContext = default)
        {
            ...
            return CompareAssignedSlots(candidate.SecondInstructionSlots, current.SecondInstructionSlots) < 0;
        }
