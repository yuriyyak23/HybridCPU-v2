...
internal static class CompatFreezeGateCatalog
{
    ...
    internal static readonly SymbolAllowance VliwInstructionMentions = new(
        ...
        [
            ...
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Helpers.Core.cs"),
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Helpers.Vector.cs"),
    ...
    internal static readonly SymbolAllowance InstructionsEnumMentions = new(
        ...
        [
            ...
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Helpers.Vector.cs"),
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Initialize.Base.cs"),
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Initialize.Scalar.cs"),
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Initialize.Vector.cs"),
            RelativePath("HybridCPU_ISE", "NonRTL", "Core", "Diagnostics", "InstructionRegistry.Runtime.cs"),
