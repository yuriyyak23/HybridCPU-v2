...
{
    [Fact]
    public void Through12Docs_HaveAdrFixturePathsAndFinalReadinessTraceability()
    {
    ...
    [Fact]
    public void Through12Docs_DoNotClaimActivationOrPositiveBackendPaths()
    {
    ...
    [Fact]
    public void Through12FocusedFixtures_ArePresentAndRemainStaticOrNegativeClosureGuards()
    {
    ...
    [
        new(
            ...
            PrimaryAnchor: "HybridCPU_ISE/CloseToHSL/Core/Runtime/Domains/SecureCompute/Descriptors/Nested/SecureChildDomainIntentDescriptor.cs",
        ...
        new(
            ...
            PrimaryAnchor: "HybridCPU_ISE/CloseToHSL/Core/Runtime/Domains/Admission/Memory/MemoryDomainRuntime.cs",
        ...
        new(
            ...
            PrimaryAnchor: "HybridCPU_ISE/CloseToHSL/Core/Runtime/Domains/SecureCompute/Policies/Backend/SecureBackendOwnerAdmissionPolicy.cs",
