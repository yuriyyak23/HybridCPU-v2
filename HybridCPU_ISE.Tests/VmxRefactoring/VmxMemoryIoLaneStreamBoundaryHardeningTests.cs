...
public sealed class VmxMemoryIoLaneStreamBoundaryHardeningTests
{
    ...
    [Fact]
    public void Phase10Source_DoesNotWireLaneStreamHelpersIntoVmxBackendPublicationOrSecureCompute()
    {
    ...
    [Fact]
    public void Phase10Source_KeepsMutableVmcsStoresAndCompatibilityExecutionManagersAbsent()
    {
