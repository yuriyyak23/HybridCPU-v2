...
using InstructionClass = YAKSys_Hybrid_CPU.Arch.InstructionClass;
using SerializationClass = YAKSys_Hybrid_CPU.Arch.SerializationClass;
...
public sealed class InstructionRegistryFactoryCoverageTests
{
        ...
        SerializationClass expectedSerialization)
    {
        ...
        Assert.Equal(expectedKind, carrier.CommandKind);
        Assert.Equal(InstructionClass.System, (InstructionClass)(byte)carrier.InstructionClass);
        Assert.Equal(expectedSerialization, carrier.SerializationClass);
        Assert.Equal(SlotClass.SystemSingleton, (SlotClass)(byte)carrier.Placement.RequiredSlotClass);
        ...
        string mnemonic)
    {
        ...
        Assert.Equal(InstructionClass.System, (InstructionClass)(byte)info.Value.InstructionClass);
        Assert.Equal(SerializationClass.FullSerial, (SerializationClass)(byte)info.Value.SerializationClass);
        ...
        Assert.Equal(SlotClass.SystemSingleton, (SlotClass)(byte)microOp.AdmissionMetadata.Placement.RequiredSlotClass);
        ...
        byte expectedLatency)
    {
        ...
        Assert.Equal(InstructionClass.ScalarAlu, (InstructionClass)(byte)info.Value.InstructionClass);
        Assert.Equal(SerializationClass.Free, (SerializationClass)(byte)info.Value.SerializationClass);
        ...
        Assert.Equal(InstructionClass.ScalarAlu, (InstructionClass)(byte)microOp.InstructionClass);
        Assert.Equal(SerializationClass.Free, (SerializationClass)(byte)microOp.SerializationClass);
        Assert.False(microOp.IsMemoryOp);
        ...
        Assert.True(microOp.SafetyMask.IsNonZero);
        Assert.True(microOp.AdmissionMetadata.StructuralSafetyMask.IsNonZero);
        Assert.Equal(SlotClass.AluClass, (SlotClass)(byte)microOp.AdmissionMetadata.Placement.RequiredSlotClass);
        ...
        ulong expectedWriteAddress)
    {
        ...
        Assert.Equal(InstructionFlags.MemoryRead, info.Value.Flags & InstructionFlags.MemoryRead);
        Assert.Equal(InstructionFlags.MemoryWrite, info.Value.Flags & InstructionFlags.MemoryWrite);
        Assert.Equal(InstructionClass.Memory, (InstructionClass)(byte)info.Value.InstructionClass);
        ...
        Assert.Equal(InstructionClass.Memory, (InstructionClass)(byte)microOp.InstructionClass);
        ...
        Assert.Equal(SlotClass.LsuClass, (SlotClass)(byte)microOp.AdmissionMetadata.Placement.RequiredSlotClass);
        Assert.Equal(SlotPinningKind.ClassFlexible, microOp.AdmissionMetadata.Placement.PinningKind);
        Assert.False(microOp.TryGetPrimaryWriteBackResult(out _));
