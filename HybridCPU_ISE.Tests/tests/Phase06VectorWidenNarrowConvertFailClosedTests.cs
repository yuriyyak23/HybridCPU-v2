...
public sealed class Phase06VectorWidenNarrowConvertFailClosedTests
{
    ...
    [Fact]
    public void Phase06Rows_RemainReservedNoAllocationAndDoNotPublishOpcodeSurface()
    {
    ...
    [Fact]
    public void Phase06Rows_DoNotReuseClosedVzextOrBaseArithmeticEvidence()
    {
