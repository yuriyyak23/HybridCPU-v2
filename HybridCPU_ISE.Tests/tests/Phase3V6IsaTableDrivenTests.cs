...
namespace HybridCPU_ISE.Tests.IsaV6
{
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public class OpcodeInfoIsMathOrVectorTests
    {
        ...
        public void T6P3_00_OpcodeRegistry_SplitAggregate_InitializesAllCollections()
        {
            ...
            Assert.NotNull(OpcodeRegistry.GetInfo((uint)InstructionsEnum.ADD));
        ...
        [Theory]
        [InlineData((uint)InstructionsEnum.ADD)]
        [InlineData((uint)InstructionsEnum.SUB)]
        [InlineData((uint)InstructionsEnum.MUL)]
        ...
        [Theory]
        [InlineData((uint)InstructionsEnum.ADD, true)]
        ...
        [InlineData((uint)InstructionsEnum.ADD, false)]
        [InlineData((uint)InstructionsEnum.ECALL, false)]
        [InlineData((uint)InstructionsEnum.FENCE, false)]
