...
{
    [Fact]
    public void Phase07_DscStatus_OpcodeDecoderRegistryAndProjectionPublishLane6Carrier()
    {
    ...
    [Fact]
    public void Phase07_DscStatus_ExecuteCaptureRetireWritebackObservesCommitPendingTokenOnlyAtRetire()
    {
    ...
    [Fact]
    public void Phase07_DscStatus_InvalidAndForeignTokensRejectAtRetireWithoutWriteback()
    {
        DmaStreamComputeDescriptor descriptor = CreateStatusOwnedDescriptor();
        Processor.CPU_Core core = CreateCoreWithStagedCopy(descriptor, out DmaStreamComputeMicroOp compute);
    ...
    [Fact]
    public void Phase07_DscStatus_ReplayRollbackEvidenceChangesAfterTokenCancelWithoutPublishingMemory()
    {
        DmaStreamComputeDescriptor descriptor = CreateStatusOwnedDescriptor();
        Processor.CPU_Core core = CreateCoreWithStagedCopy(descriptor, out DmaStreamComputeMicroOp compute);
        core.WriteCommittedArch(0, TokenRegister, compute.LastExecutionTokenHandle.TokenId);
    ...
    [Fact]
    public void Phase07_DscStatus_DoesNotConsumeOutstandingTokenCapacity()
    {
    ...
    [Fact]
    public void Phase07_DscStatus_AdjacentQueueControlDsc2Lane7AndCompilerBoundariesStayClosed()
    {
        var decoder = new VliwDecoderV4();
