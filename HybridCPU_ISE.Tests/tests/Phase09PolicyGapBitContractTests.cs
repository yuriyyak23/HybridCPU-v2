...
public sealed class CompatIngressStrictGateCollection;

[Collection("Phase09 Compat Ingress Strict Gate")]
public sealed class PolicyGapBitContractTests
{
    [Fact]
    ...
    public void PolicyGapBitZero_CompilerBundleIngressDoesNotRoundTripRetiredBit()
    {
        ...
        HybridCpuInstructionBundle loweredBundle = new HybridCpuBundleLowerer().LowerBundle(materializedBundle);
        HybridCpuInstructionWord loweredInstruction = loweredBundle.GetInstruction(0);
