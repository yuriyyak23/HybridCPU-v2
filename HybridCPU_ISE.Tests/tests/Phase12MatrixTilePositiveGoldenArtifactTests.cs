...
public sealed class MatrixTilePositiveGoldenArtifactTests
{
    [Fact]
    ...
    public void LegalGoldenCarriersRoundTripThroughEncoderSerializationAndCanonicalDecoder()
    {
                 ...
                 MatrixTilePositiveGoldenArtifactManifest.ExecutionVectors)
        {
            ...
            DecodedInstructionBundle bundle = new VliwDecoderV4().DecodeInstructionBundle(
                slots,
                CreateRuntimeAnnotations(vector.Opcode),
    ...
    [Fact]
    public void ManifestIsRegeneratedButPhase14OwnsPromotionAndHandoff()
    {
        ...
        MatrixTileGoldenCarrier carrier)
    {
        ...
        DecodedInstructionBundle bundle = decoder.DecodeInstructionBundle(
            slots,
            CreateRuntimeAnnotations((InstructionsEnum)slots[0].OpCode),
            bundleAddress: 0x1000,
            bundleSerial: 11);
        InstructionIR ir = bundle.GetDecodedSlot(0).RequireInstruction();
        MicroOp?[] carriers =
    ...
    private static VliwBundleAnnotations CreateRuntimeAnnotations(
