...
public sealed class L7SdcPhase08AStatusTests
{
    ...
    [Fact]
    public void Phase08A_StatusOpcodeStatusClassifierAndRegistry_AreRuntimeOwned()
    {
    ...
    [Fact]
    public void Phase08A_StatusDecoderIrProjectionAndLegality_AreHardPinnedLane7()
    {
    ...
    [Fact]
    public void Phase08A_StatusConflictsWithBranchControlPressureOnAliasedLane7()
    {
        var rawSlots = new VLIW_Instruction[BundleMetadata.BundleSlotCount];
    ...
    [Fact]
    public void Phase08A_StatusRejectsWrongLaneDirtyRs2AndDescriptorSideband()
    {
    ...
    [Fact]
    public void Phase08A_StatusMaterializerRejectsNonZeroRs2()
    {
    ...
    [Fact]
    public void Phase08A_StatusExecuteCaptureAndRetireWritesPackedStatusOnlyThroughRuntime()
    {
    ...
    [Fact]
    public void Phase08A_StatusInvalidHandleHasExplicitNoResultRetireSemantics()
    {
        var core = new Processor.CPU_Core(0);
        var status = new AcceleratorStatusMicroOp(StatusRegister, TokenRegister);
    ...
    [Fact]
    public void Phase08A_StatusRollbackAndReplayDoNotPublishBeforeRetire()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void Phase08A_UnselectedResultAndResetRemainReservedAndUnallocated()
    {
    ...
    [Fact]
    public void Phase08A_StatusCompilerBoundaryKeepsCarrierOnlySubmitSurface()
    {
