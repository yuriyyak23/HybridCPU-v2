...
{
    [Fact]
    public void Phase09_Lane7DescriptorTaxonomy_PinsCurrentMatMulAndTensorMetadataOnly()
    {
    ...
    [Fact]
    public void Phase09_TensorCapabilityMetadata_CanBeQueriedButDoesNotWidenRuntimeAuthority()
    {
    ...
    [Fact]
    public void Phase09_TensorDescriptorBytes_AreHeaderReadableButParserRejectedBeforeTokenPublication()
    {
    ...
    [Fact]
    public void Phase09_Lane6Dsc2Taxonomy_RemainsParserOnlyAndNoCompilerOrTokenAuthority()
    {
