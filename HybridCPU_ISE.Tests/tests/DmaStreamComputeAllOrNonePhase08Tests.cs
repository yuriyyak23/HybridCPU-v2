...
{
    [Fact]
    public void MissingStagedWriteCoverage_FaultsBeforeCommitPending()
    {
    ...
    [Fact]
    public void StagedWriteOutsideNormalizedFootprint_FaultsWithoutMemoryEffects()
    {
        InitializeMainMemory(0x10000);
    ...
    [InlineData(false)]
    [InlineData(true)]
    public void OverlappingOrDuplicateStagedWrites_DoNotCreatePartialSuccess(
        bool duplicateWrite)
    {
        InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void CommitWriteFailure_RollsBackAllPriorAndFailedRangeBytes()
    {
    ...
    [Fact]
    public void CancelOrFaultBeforeCommit_LeavesMemoryUnchanged()
    {
        InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void ProgressDiagnosticsRemainMetadataOnly()
    {
        InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void PollingOrProgressObservation_DoesNotPublishStagedMemory()
    {
        InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void Dsc1NonAllOrNonePolicy_RejectsAsReserved()
    {
    ...
    [Fact]
    public void Dsc2PartialSuccessExtension_RejectsWhileGateClosed()
    {
    ...
    [Fact]
    public void Dsc1ExecutableButQueueAndControlBoundariesRemainFailClosed()
    {
        InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void CompilerProductionLoweringToPartialSuccessDscDsc2OrL7_RemainsForbidden()
    {
