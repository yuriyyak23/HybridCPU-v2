...
{
    public sealed class ClaimSafetyDocumentationTests
    {
        [Theory]
        ...
        public void T9_08q_ReadmeEntryPoint_PointsToCurrentAuthority_AndNarrowsTypedSlotFactClaims()
        {
            ...
            string referencesText = ReadRepoFile("Documentation\\Documentation\\ArchitectureAuthorityRefactor\\Reference\\references-and-reading-order.md");
