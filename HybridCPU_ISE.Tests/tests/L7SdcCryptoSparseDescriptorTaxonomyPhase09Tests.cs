...
{
    [Fact]
    public void Phase09_CryptoHashTaxonomy_IsMetadataOnlyAndGrantsNoAuthority()
    {
    ...
    [Fact]
    public void Phase09_SparseGraphTaxonomy_IsMetadataOnlyAndGrantsNoAuthority()
    {
        AssertMetadataOnlyTaxonomy(
    ...
    [Fact]
    public void Phase09_CryptoHashCapabilityProvider_IsQueryableButNotRuntimeRegistered()
    {
    ...
    [Fact]
    public void Phase09_SparseGraphCapabilityProvider_IsQueryableButNotRuntimeRegistered()
    {
        AssertProviderQueryableButNotRuntimeRegistered(
    ...
    [Fact]
    public void Phase09_CryptoHashDescriptorHeaderReadsButParserRejectsBeforeAcceptance()
    {
    ...
    [Fact]
    public void Phase09_SparseGraphDescriptorHeaderReadsButParserRejectsBeforeAcceptance()
    {
        AssertDescriptorHeaderReadableButParserRejected(
            AcceleratorClassId.SparseGraph,
            AcceleratorDeviceId.SparseGraphMetadata,
    ...
    [Fact]
    public void Phase09_CryptoHashMetadataCannotIssueTokensResultsFaultsOrBackendWork()
    {
    ...
    [Fact]
    public void Phase09_SparseGraphMetadataCannotIssueTokensResultsFaultsOrBackendWork()
    {
        AssertMetadataCannotIssueTokens(
            new SparseGraphMetadataCapabilityProvider(),
            SparseGraphMetadataCapabilityProvider.AcceleratorId,
    ...
    [Fact]
    public void Phase09_CompilerSurfaceKeepsCryptoSparseAndAdjacentDescriptorNoEmissionBoundary()
    {
