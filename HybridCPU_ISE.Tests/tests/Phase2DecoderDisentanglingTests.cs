...
namespace HybridCPU_ISE.Tests.IsaV5
{
    ...
    {
        public static InstructionIR Alu(InstructionsEnum opcode = InstructionsEnum.ADD,
    ...
    public class SlotMetadataBuilderTests
    {
    ...
    public class InternalOpBuilderTests
    {
        private readonly IInternalOpBuilder _builder = new InternalOpBuilder();

        [Theory]
        [InlineData(InstructionsEnum.ADD,    InternalOpKind.Add)]
        [InlineData(InstructionsEnum.SUB, InternalOpKind.Sub)]
        [InlineData(InstructionsEnum.MUL, InternalOpKind.Mul)]
        ...
        {
            // Arrange
            InstructionIR ir = IrFactory.Alu(InstructionsEnum.ADD, rd: 5, rs1: 3, rs2: 7);
        ...
        public void T2_MapToKind_IsStateless_SamOpcodeAlwaysSameKind()
        {
            ...
            InternalOpKind first  = InternalOpBuilder.MapToKind((ushort)InstructionsEnum.ADD);
            InternalOpKind second = InternalOpBuilder.MapToKind((ushort)InstructionsEnum.ADD);
    ...
    public class InstructionIrExtensionTests
    {
        [Fact]
