...
public sealed class NativeVliwDiagnosticDecodeTests
{
        ...
        int round)
    {
        ...
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.ADD, destinationRegisterBase, registerBase + 1, registerBase + 2);
        ...
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.SLL, destinationRegisterBase + 2, registerBase + 5, rotateRegister);
        ...
        int round)
    {
        ...
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.MUL, destinationRegisterBase, registerBase + 1, registerBase + 2);
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.ADD, destinationRegisterBase + 1, registerBase + 3, registerBase + 4);
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.MUL, destinationRegisterBase + 2, registerBase + 5, registerBase + 6);
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.ADD, destinationRegisterBase + 3, registerBase + 7, rotateRegister);
    }
    ...
    {
        int rotateRegister = registerBase + 1 + (round & 0x3);
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.SLL, destinationRegisterBase, rotateRegister, registerBase + 2);
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.ADD, destinationRegisterBase + 1, registerBase, registerBase + 3);
        ...
        int round)
    {
        ...
        EmitBinaryScalar(instructions, metadata, ref instructionCount, virtualThreadId, Processor.CPU_Core.InstructionsEnum.MUL, destinationRegisterBase + 3, registerBase + 2, registerBase + 7);
    }
