...
public sealed class L7SdcPhase10GateTests
{
    ...
    public void CurrentAccelCarriersAreLane7RuntimeOwnedAndNoFallback(
        ...
        Type expectedCarrierType)
    {
        ...
        Assert.Equal(SlotClass.SystemSingleton, (SlotClass)(byte)command.Placement.RequiredSlotClass);
    ...
    [Fact]
    public void SystemDeviceCarrierSourceDoesNotWireModelApisIntoExecution()
    {
    ...
    [Fact]
    public void RegisterAbiPackingIsModelSideOnly()
    {
    ...
    [Fact]
    public void FakeMatMulBackendIsTestOnlyAndCannotPublishWithoutCommitCoordinator()
    {
    ...
    [Fact]
    public void TokenQueueFenceModelsRemainGuardedWhileMicroOpsUseRuntimeOwner()
    {
        L7SdcPhase07Fixture fixture =
            L7SdcPhase07TestFactory.CreateAcceptedToken();
    ...
    [Fact]
    public void CompilerEmissionIsCarrierSidebandNotProductionExecutableProtocol()
    {
    ...
    [Fact]
    public void DocsAndAdrKeepCurrentContractModelOnlyAndFailClosed()
    {
