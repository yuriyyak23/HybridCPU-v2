...
//   [T3-08] ICanonicalCpuState.ReadRegister always requires vtId parameter — no overload without vtId
//   [T3-09] VT register bank: x0 always reads as 0 regardless of write attempts
//   [T3-10] PipelineFsmGuard.Advance: HaltEvent drives Task→Halted, ResetEvent drives Reset→Task
...
namespace HybridCPU_ISE.Tests.IsaV5
{
    // ─────────────────────────────────────────────────────────────────────────
    // Test helpers
    // ─────────────────────────────────────────────────────────────────────────
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // T3-01 / T3-02 — ExecutionEngine dispatch
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public sealed class ExecutionEngineDispatchTests
    {
        ...
        // ── T3-01c: registry covers every enum member ─────────────────────
        [Fact]
        ...
        // ── T3-02: unregistered kind throws ──────────────────────────────
        [Fact]
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // T3-03 — ISA opcode isolation (engine types must not depend on ISA opcodes)
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public sealed class IsaOpcodeIsolationTests
    {
        ...
        // ── T3-03a: IExecutionUnit.Execute only uses InternalOp + ICanonicalCpuState ──
        [Fact]
        ...
        // ── T3-03b: ExecutionEngine has no ISA opcode type in any method signature ──
        [Fact]
        ...
        // ── T3-03c: InvalidInternalOpException carries InternalOpKind, not ISA enum ──
        [Fact]
        ...
        public void T3_03d_IExecutionUnit_InterfaceHasNoIsaTypeDependency()
        {
            ...
            // Parameters must be InternalOp and ICanonicalCpuState — no ISA-specific types
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // T3-04 / T3-10 — PipelineFsmGuard single authority + Advance method
    // ─────────────────────────────────────────────────────────────────────────

    public sealed class PipelineFsmGuardAdvanceTests
    {
        // ── T3-04: PipelineFsmGuard.Advance is a public static method ────
        [Fact]
        ...
        // ── T3-10: HaltEvent drives Task→Halted ──────────────────────────
        [Fact]
        ...
        public void T3_10h_PipelineFsmGuard_WhenMretEventFromTask_ThenThrowsIllegalTransition()
        {
            ...
            // Task has no TrapReturn transition — MRET outside a trap handler is illegal.
        ...
        // Advance must ultimately call Transition → illegal transitions still throw
        [Fact]
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // T3-05 / T3-06 / T3-07 — CommitUnit + VT isolation
    // ─────────────────────────────────────────────────────────────────────────
    ...
    public sealed class CommitUnitTests
    {
        ...
        // ── T3-05: VT isolation — write to VT0 does not affect VT1 ──────
        [Fact]
        ...
        // ── T3-06: program order — FIFO within VT ────────────────────────
        [Fact]
        ...
        // ── T3-06c: PC redirect is committed ──────────────────────────────
        [Fact]
        ...
        // ── T3-06d: Rd=0 write is silently discarded ──────────────────────
        [Fact]
    ...
    // ─────────────────────────────────────────────────────────────────────────
    // T3-08 / T3-09 — ICanonicalCpuState VT-scoped + VtRegisterBank x0 contract
    // ─────────────────────────────────────────────────────────────────────────

    public sealed class UnifiedRetireStateTests
    {
        // ── T3-08: ICanonicalCpuState.ReadRegister requires vtId ───────────────────
        [Fact]
        ...
        // ── T3-09: VtRegisterBank x0 contract ────────────────────────────
        [Fact]
        ...
        // ── T3-07: 4-VT isolation via VtRegisterBank directly ────────────

        // ── ICanonicalCpuState.ReadRegister default implementation delegating properly ──\r\n}
