...
public sealed class Ex1Phase12ConformanceMigrationTests
{
    ...
    [Fact]
    public void EveryEx1PhaseHasMappedConformanceCategory()
    {
    ...
    [Fact]
    public void DocumentationClaimSafetyBlocksForbiddenCurrentClaims()
    {
    ...
    [Fact]
    public void CompatibilityEvidenceKeepsDmaStreamScopedAndL7CurrentRuntimeOwned()
    {
    ...
    [Fact]
    public void FutureClaimMigrationRequiresApprovalCodeTestsCompilerAndDocsEvidence()
    {
        string phase12 = ReadRepoFile(
            "Documentation/Refactoring/Phases Ex1/12_Testing_Conformance_And_Documentation_Migration.md");
    ...
    [Fact]
    public void HelperParserModelAndFakeBackendEvidenceCannotSatisfyExecutableIsa()
    {
