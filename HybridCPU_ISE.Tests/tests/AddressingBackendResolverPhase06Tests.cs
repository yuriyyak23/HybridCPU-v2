...
public sealed class AddressingBackendResolverPhase06Tests
{
    ...
    [Fact]
    public void PhysicalAddressSpaceSelectsPhysicalWrapperOnlyAndHelperRemainsPhysical()
    {
    ...
    [Fact]
    public void IommuTranslatedSelectionUsesExplicitIommuBackendWithApprovedDeviceId()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void UnsupportedOrMissingIommuBackendRejectsWithoutPhysicalFallback()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
    ...
    [Fact]
    public void DeviceOwnerDomainAndMappingEpochMismatchRejectBeforeBackendSelection()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
    ...
    [Fact]
    public void L7IommuRequestCarriesGuardBackedDeviceAndMappingEpoch()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void AddressingFaultsMapToDscFaultRecordsWithoutMemoryPublication()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void Dsc1ExecutesWhileCompilerLoweringAndControlBoundariesRemainClosed()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
