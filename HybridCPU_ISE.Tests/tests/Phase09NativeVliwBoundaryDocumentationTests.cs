    ...
    public sealed class NativeVliwBoundaryDocumentationTests
    {
        ...
        public void T9_08j_ArchitectureAuthorityRefactorSummary_PreservesPublicFrontendAndFaultEvidence()
        {
            string decoderClosure = ReadRepoFile(
                "Documentation\\Documentation\\ArchitectureAuthorityRefactor\\Evidence\\RF06\\rf00-rf06-documentation-reconciliation.md");
            string audit = ReadRepoFile("Documentation\\Documentation\\ArchitectureAuthorityRefactor\\Evidence\\RF07\\rf07.exit-final-closed-world-audit.md");
