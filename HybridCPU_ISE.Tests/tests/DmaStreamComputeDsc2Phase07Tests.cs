...
{
    [Fact]
    public void Dsc1CompatibilityRemainsStrictAndCurrentOnly()
    {
    ...
    [Fact]
    public void Dsc2KnownParserOnlyStridedDescriptorNormalizesExactWithoutExecutionAuthority()
    {
    ...
    [Fact]
    public void Dsc2MalformedHeadersAndExtensionTablesReject()
    {
    ...
    [Fact]
    public void Dsc2UnknownExtensionCompatibilityRulesAreExplicit()
    {
    ...
    [Fact]
    public void Dsc2AbsentCapabilityRejectsDependentExtension()
    {
        byte[] descriptorBytes = BuildDsc2(
            StridedRangeExtension(DmaStreamComputeDsc2AccessKind.Read, 4, 4, 0x1000, 4));
    ...
    [Fact]
    public void Dsc2NormalizedFootprintsAreDeterministicExactConservativeAndRejectUnsafeCases()
    {
    ...
    [Fact]
    public void Dsc2TileAndScatterGatherFootprintsNormalizeWithoutExecutionAuthority()
    {
        byte[] descriptorBytes = BuildDsc2(
    ...
    [Fact]
    public void Dsc2AddressSpaceDeviceDomainAndMappingEpochMismatchesReject()
    {
    ...
    [Fact]
    public void Dsc2ParserKnownCapabilitiesDoNotEnableTokenIssueMemoryEffectsOrCompilerLowering()
    {
        byte[] descriptorBytes = BuildDsc2(
            PhysicalAddressSpaceExtension(),
    ...
    [Fact]
    public void Dsc1ExecutesWhileDsc2AndControlBoundariesRemainClosed()
    {
