...
{
    [Fact]
    public void HelperFaultsRemainModelRetireStyleNotPipelinePrecise()
    {
    ...
    [Fact]
    public void RetirePublicationMetadataCarriesFuturePreciseIdentity()
    {
    ...
    [Fact]
    public void CommitPendingDoesNotMeanMemoryVisible()
    {
    ...
    [Fact]
    public void FaultedAndCanceledTokensNeverPublishMemory()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void CommitFailureIsFaultNotSuccessfulPartialCompletion()
    {
    ...
    [Fact]
    public void BackendExceptionsNormalizeIntoTokenFaultRecords()
    {
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
    ...
    [Fact]
    public void PublicationSurfaceRemainsExplicitFutureSeamNotNormalLane6Path()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
        DmaStreamComputeActiveTokenEntry entry = AllocateEntry();
        DmaStreamComputeRetireObservation observation =
