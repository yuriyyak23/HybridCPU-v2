// Phase 09: VMX Subsystem — Instruction Plane + FSM Transitions
// Covers:
...
namespace HybridCPU_ISE.Tests
{
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 1. VmExitReason — VMEXIT Reason Codes
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 2. VmxEventKind — VMX Diagnostic Event Kinds
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 3. VmcsField — VMCS Field Identifiers
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 4. VmcsManager — VMCS Lifecycle Management
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    public sealed class VmcsManagerTests
    {
        ...
        public void MultipleVmcs_IndependentFieldStorage()
        {
            ...
            // Switch back to VMCS 0x1000 — its value should be preserved
            mgr.Load(0x1000);
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 5. NullVmxEventSink — Default No-Op Trace
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 6. ExecutionResult — VmxFault Extension
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 7. VmxExecutionUnit — VMXON / VMXOFF Cycle
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 8. VmxExecutionUnit — Privilege Enforcement
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 9. VmxExecutionUnit — VMLAUNCH / VMRESUME / FSM Transitions
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 10. VmxExecutionUnit — VMREAD / VMWRITE
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 11. VmxExecutionUnit — VMCLEAR / VMPTRLD
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 12. VmxExecutionUnit — VMXOFF from GuestExecution (VM-Exit path)
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 13. VmxExecutionUnit — Full VM Entry/Exit Cycle
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    public sealed class VmEntryExitCycleTests
    {
        ...
        public void FullCycle_Launch_VmxOff_Resume()
        {
            ...
            // VMRESUME — VMCS is still launched
            _vmx.Execute(VmxIrHelper.MakeVmx(InstructionsEnum.VMRESUME), _state, PrivilegeLevel.Machine);
            Assert.Equal(PipelineState.GuestExecution, _state.GetCurrentPipelineState());
        }
    }
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // 14. ExecutionDispatcherV4 — VMX Dispatch Delegation
    // ═══════════════════════════════════════════════════════════════════════════
