...
public sealed class InstructionRegistryPublishedDescriptorTests
{
    [Fact]
    ...
    [Theory]
    [InlineData(InstructionsEnum.ADD, 1)]
    [InlineData(InstructionsEnum.SUB, 1)]
    [InlineData(InstructionsEnum.MUL, 3)]
    [InlineData(InstructionsEnum.DIV, 16)]
