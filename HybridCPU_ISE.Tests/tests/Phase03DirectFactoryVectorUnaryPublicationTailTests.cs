...
public sealed class Phase03DirectFactoryVectorUnaryPublicationTailTests
{
    [Theory]
    ...
    public void DirectFactoryVectorUnary_ProjectsSingleSurfaceMemoryShapeBeforeManualPublication(
        InstructionsEnum opcode)
    {
        var core = new Processor.CPU_Core(0);
        core.PrepareExecutionStart(0xAD00);

        VectorUnaryOpMicroOp microOp = CreateDirectFactoryVectorUnaryMicroOp(opcode);
    ...
    private static VectorUnaryOpMicroOp CreateDirectFactoryVectorUnaryMicroOp(
        InstructionsEnum opcode)
    {
        ...
        return Assert.IsType<VectorUnaryOpMicroOp>(
