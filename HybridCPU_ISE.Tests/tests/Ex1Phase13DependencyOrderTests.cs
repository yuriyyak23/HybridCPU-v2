...
{
    [Fact]
    public void DependencyGraphNamesMajorFutureClaimsAndBlockers()
    {
    ...
    [Fact]
    public void DocsRemainPlanningOnlyAndApproveNoExecutableClaims()
    {
    ...
    [Fact]
    public void DownstreamEvidenceCannotSatisfyUpstreamExecutionGates()
    {
        string combined = ReadPhase13AndAdr13();
    ...
    [Fact]
    public void KeepsPhase12AsMigrationGateAndCompilerLoweringAsLastMile()
    {
