...
public sealed class Phase13MatrixTileCompilerHandoffTests
{
    ...
    [Fact]
    public void RuntimePackageClosesPhase14AndRecordsExistingCompilerImplementation()
    {
    ...
    [Fact]
    public void CurrentCompilerSurfacesConsumePhase13HandoffAsSeparateImplementation()
    {
