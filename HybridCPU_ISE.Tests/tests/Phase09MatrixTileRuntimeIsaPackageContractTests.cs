...
public sealed class Phase09MatrixTileRuntimeIsaPackageContractTests
{
    ...
    public void MatrixTileRuntimeIsaPackage_PublishesPositiveGoldenManifestAndRetainsNegativeHistory()
    {
        ...
        Assert.Equal(
            "CloseToRTL/Core/ISA/Instructions/NonVmx/Docs/ImplPlan/PHASE_09B_MATRIX_TILE_NEGATIVE_GOLDEN_MANIFEST_2026-06-07.md",
    ...
    [Fact]
    public void MatrixTileRuntimeIsaPackage_AllowsSeparatePositiveCompilerImplementationHandoff()
    {
