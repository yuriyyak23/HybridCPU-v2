...
public sealed class CacheNonCoherentCollection;

[Collection("Phase09 Cache NonCoherent")]
public sealed class CachePrefetchNonCoherentPhase09Tests
{
    [Fact]
    public void ExplicitObserverInvalidatesOnlyOverlappingDataCacheLines()
    {
    ...
    [Fact]
    public void DomainFlushBehaviorRemainsDataCacheScoped()
    {
        Processor.CPU_Core core = CreateCoreWithCaches();
    ...
    [Fact]
    public void AssistResidentAndSrfOverlappingWindowsInvalidateThroughObserver()
    {
        Processor.CPU_Core core = CreateCoreWithCaches();
    ...
    [Fact]
    public void DataOnlyObserverDoesNotInvalidateVliwFetchState()
    {
        Processor.CPU_Core core = CreateCoreWithCaches();
    ...
    [Fact]
    public void CodeBundleWriteRequiresExplicitVliwInvalidationPath()
    {
        Processor.CPU_Core core = CreateCoreWithCaches();
    ...
    [Fact]
    public void FlushBeforeExternalReadIsNoOpProofForReadMaterializedNonDirtyCache()
    {
        Processor.CPU_Core core = CreateCoreWithCaches();
    ...
    [Fact]
    public void DmaStreamCommitObserverInvalidatesDataCacheAndKeepsPhase06ExecutionScoped()
    {
    ...
    [Fact]
    public void L7CommitObserverInvalidatesDataCacheAndCarriersRemainFailClosed()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void DmaControllerAndPhysicalBurstBackendInvalidateOnlyWhenObserverIsExplicitlyRouted()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void AtomicPhysicalWriteNotificationPolicyInvalidatesReservationsNotDataCache()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void CodeAndCompilerSurfacesDoNotClaimCoherentDmaOrAutomaticCoherency()
    {
