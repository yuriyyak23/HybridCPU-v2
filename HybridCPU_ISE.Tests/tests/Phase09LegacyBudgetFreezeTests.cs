...
/// </summary>
public sealed class LegacyBudgetFreezeTests
{
    ...
    public void CanonicalExecutePath_DoesNotConsumeLegacyRetireCompatibilityBudget()
    {
        ...
        core.TestRunExecuteStageWithDecodedInstruction(
            CreateScalarInstruction(InstructionsEnum.ADD, rd: 1, rs1: 2, rs2: 3),
            new SucceedingScalarMicroOp((uint)InstructionsEnum.ADD, destReg: 1),
            writesRegister: true,
            reg1Id: 1,
            reg2Id: 2,
            reg3Id: 3,
