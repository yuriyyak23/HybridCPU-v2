...
public sealed class L7SdcPhase08ExecutableTests
{
    ...
    public void CurrentL7SdcCommandsPublishExecutableStatusOnlyInsideScopedContour(
    ...
    public void A_UnselectedCommandsRemainReservedAndUnallocated(string mnemonic)
    {
        InstructionSupportStatus status = InstructionSupportStatusCatalog.GetStatus(mnemonic);
    ...
    [Fact]
    public void DecoderProjectionAndMaterializerPublishDescriptorBackedSubmitMicroOp()
    {
    ...
    [Fact]
    public void SubmitPollWaitFenceExecuteCaptureAndRetireThroughStagedCommit()
    {
    ...
    [Fact]
    public void QueryCapsAndCancelStayControlPlaneOnly()
    {
        Processor.MainMemoryArea previousMemory = Processor.MainMemory;
        try
        {
    ...
    [Fact]
    public void DescriptorlessSubmitRemainsAdjacentFailClosed()
    {
        var core = new Processor.CPU_Core(0);
