...
public sealed class Phase03DirectFactoryVectorReductionPublicationTailTests
{
    [Theory]
    ...
    public void DirectFactoryVectorReductionScalarResultFamily_PublishesScalarFootprintBeforeManualPublication(
        InstructionsEnum opcode)
    {
        var core = new Processor.CPU_Core(0);
        core.PrepareExecutionStart(0xA800);

        VectorReductionMicroOp microOp = CreateDirectFactoryVectorReductionMicroOp(opcode);
    ...
    public void DirectFactoryVectorReductionBitwise_PublishesScalarFootprintBeforeManualPublication(
        InstructionsEnum opcode)
    {
        var core = new Processor.CPU_Core(0);
        core.PrepareExecutionStart(0xA840);
    ...
    private static VectorReductionMicroOp CreateDirectFactoryVectorReductionMicroOp(InstructionsEnum opcode)
    {
        ...
        return Assert.IsType<VectorReductionMicroOp>(InstructionRegistry.CreateMicroOp((uint)opcode, context));
    }
