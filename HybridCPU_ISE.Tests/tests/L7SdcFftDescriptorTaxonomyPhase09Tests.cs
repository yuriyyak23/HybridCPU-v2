...
{
    [Fact]
    public void FftTaxonomy_IsMetadataOnlyAndGrantsNoAuthority()
    {
    ...
    [Fact]
    public void FftCapabilityProvider_IsQueryableButNotRuntimeRegistered()
    {
    ...
    [Fact]
    public void FftDescriptorHeaderReadsButParserRejectsBeforeAcceptance()
    {
    ...
    [Fact]
    public void FftMetadataCannotIssueTokensResultsFaultsOrBackendWork()
    {
    ...
    [Fact]
    public void CompilerSurfaceKeepsFftAndAdjacentDescriptorNoEmissionBoundary()
    {
