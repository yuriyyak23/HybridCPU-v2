...
{
    [Fact]
    public void AbsentServicePreservesScalarDscAndL7CurrentBehavior()
    {
    ...
    [Fact]
    public void PresentPassiveReportsConflictsWithoutChangingMemoryResults()
    {
    ...
    [Fact]
    public void OverlappingDscL7AndCpuFootprintsClassifyDeterministically()
    {
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
    ...
    [Fact]
    public void NonOverlappingFootprintsDoNotCreateFalseConflicts()
    {
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
        var service = GlobalMemoryConflictService.CreatePresentPassive();
    ...
    [Fact]
    public void ParticipantIdentityCarriesDomainDeviceTokenAndMappingEpochRequirements()
    {
        DmaStreamComputeDescriptor descriptor =
            DmaStreamComputeTestDescriptorFactory.CreateDescriptor();
    ...
    [Fact]
    public void FenceWaitAndPollRemainFutureGatedAndNeverPublishMemory()
    {
        DmaStreamComputeTelemetryTests.InitializeMainMemory(0x10000);
    ...
    [Fact]
    public void NoCpuAtomicDmaStreamOrCompilerProductionHookIsMandatory()
    {
