...
public sealed class Phase03LegacyMoveDt4HelperRejectTests
{
    [Fact]
    public void DualWriteArchRegMove_HelperSurfaceIsRemoved()
    {
    ...
    [Fact]
    public void DualWriteIntRegisterMove_HelperSurfaceIsRemoved()
    {
        Assert.False(HasMoveOverload(
