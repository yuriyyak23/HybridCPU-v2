...
{
    [Fact]
    public void A_DscQueryCaps_OpcodeDecoderRegistryAndProjectionPublishLane6Carrier()
    {
    ...
    [Fact]
    public void A_DscQueryCaps_ExecuteCaptureRetireWritebackPublishesBoundedCapabilityWord()
    {
    ...
    [Fact]
    public void A_DscQueryCaps_DoesNotIssueTokensPublishMemoryOrChangeAcrossReplayRollback()
    {
    ...
    [Fact]
    public void A_DscQueryCaps_AdjacentDsc2ShapeQueryAndCompilerBoundariesStayClosed()
    {
        var decoder = new VliwDecoderV4();
