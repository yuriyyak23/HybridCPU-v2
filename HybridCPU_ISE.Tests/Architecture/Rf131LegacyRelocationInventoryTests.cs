...
public sealed class Rf131LegacyRelocationInventoryTests
{
    ...
    public void RelocatedLiveContoursRetainTheirRuntimeAndCompatibilityCallers()
    {
        ...
        Assert.Equal(
        ["Diagnostics/TestAssemblerConsoleApps/SimpleAsmApp.Progress.cs"],
    ...
    private static string[] Callers(string token) => new[] { "HybridCPU_ISE", "Diagnostics/TestAssemblerConsoleApps" }
