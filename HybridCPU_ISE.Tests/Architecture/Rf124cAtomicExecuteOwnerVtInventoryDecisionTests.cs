...
public sealed class Rf124cAtomicExecuteOwnerVtInventoryDecisionTests
{
    ...
    public void DecisionAllowsOnlyTheAuthorizedAtomicAndScalarProjectionCallers()
    {
        ...
        Assert.Empty(FindOccurrences(root, "Compilers/HybridCPU_Compiler", projection));
        Assert.Empty(FindOccurrences(root, "Diagnostics/TestAssemblerConsoleApps", projection));
