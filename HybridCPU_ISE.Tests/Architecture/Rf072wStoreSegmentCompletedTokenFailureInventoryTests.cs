...
/// <summary>
/// RF-07.2w records the StoreSegment completed-token boundary. RF-07.2x later
/// converts its terminal failure, while this test retains the owned-wait versus
/// terminal-failure characterization.
/// </summary>
public sealed class Rf072wStoreSegmentCompletedTokenFailureInventoryTests
{
    [Fact]
    public void StoreSegmentCompletedFailedWrite_IsTerminalRatherThanRetry()
    {
