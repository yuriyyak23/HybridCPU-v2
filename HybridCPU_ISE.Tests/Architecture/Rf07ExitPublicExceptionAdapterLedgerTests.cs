...
public sealed class Rf07ExitPublicExceptionAdapterLedgerTests
{
    ...
    public void RetainedPublicExecuteAdapters_HaveOneOwnerTypedReplacementAndRf07Expiry()
    {
        ...
        Assert.Equal(2, CountOccurrences(scalarMemory, "catch (CpuInstructionTranslationFaultException)"));
        Assert.True(CountOccurrences(scalarMemory, "this.MarkFaulted();") >= 8);
