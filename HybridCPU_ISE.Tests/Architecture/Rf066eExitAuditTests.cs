...
public sealed class Rf066eExitAuditTests
{
    ...
    public void RemainingProductionTransportProjectorCallers_AreExactlyTheDeclaredCompatibilityLedger()
    {
        ...
        string[] productionRoots =
        {
            ...
            Path.Combine(root, "Compilers", "HybridCPU_Compiler"),
            Path.Combine(root, "Compilers", "CpuInterfaceBridge"),
            Path.Combine(root, "Diagnostics", "TestAssemblerConsoleApps")
        };
        ...
        var expected = new Dictionary<string, int>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Diagnostics/TestAssemblerConsoleApps/StreamVectorSpecSuite.cs"] = 1,
            ["Diagnostics/TestAssemblerConsoleApps/MatrixTileSpecSuite.cs"] = 1
        };
    ...
    {
        string root = CompatFreezeScanner.FindRepoRoot();
        string compilerRoot = Path.Combine(root, "Compilers", "HybridCPU_Compiler");
