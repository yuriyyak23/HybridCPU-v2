...
/// <summary>RF-12.7o PauseTransfer channel producer/consumer inventory.</summary>
public sealed class Rf127oDmaPauseTransferInventoryDecisionTests
{

    [Fact]
    public void InvalidAndInactiveRawInputsRetainFalseWhileActiveTransitions()
    {
