...
public sealed class Rf1119ResidualDomainAuthorityDecisionTests
{
    ...
    public void CurrentProductionRootGrowsOnlyInDecisionOrder()
    {
        ...
        Assert.True(runtime.GetFields(Flags).Length >= 12);
        ...
        Assert.Single(runtime.GetFields(Flags), field => field.FieldType.Name == "CpuInstructionTranslationState");
        Assert.Single(runtime.GetFields(Flags), field => field.FieldType.Name == "CompatibilityControlPolicyState");
