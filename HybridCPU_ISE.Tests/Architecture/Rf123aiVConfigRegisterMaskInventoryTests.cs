...
public sealed class Rf123aiVConfigRegisterMaskInventoryTests
{
    ...
    public void ClosedWorldProductionCompilerAndTestCallerManifestRemainsExact()
    {
        ...
        Assert.Empty(FindFilesContaining(root, "Compilers/HybridCPU_Compiler", "VConfigMicroOp"));
        Assert.Empty(FindFilesContaining(root, "Diagnostics/TestAssemblerConsoleApps", "VConfigMicroOp"));
        ...
        string compiler = Read(root, "Compilers", "HybridCPU_Compiler", "API", "Facade",
