...
public sealed class Rf1211aExpandedBridgeDeletionEligibilityReconciliationTests
{
    ...
    public void RepresentativeLiveCallersStillPreventDeletion()
    {
        ...
        Assert.Contains("new IrInstructionSlotMetadata(", compiler, StringComparison.Ordinal);
        Assert.Contains("instruction.VirtualThreadId,", compiler, StringComparison.Ordinal);
