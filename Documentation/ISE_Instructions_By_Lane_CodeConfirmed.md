...
- `HybridCPU_ISE/CloseToHSL/Core/Architecture/Common/CPU_Core.Enums.cs` объявляет 251 уникальный numeric opcode.
...
- `HybridCPU_ISE/CloseToHSL/Core/Pipeline/Scheduling/SlotLegality/SlotClassDefinitions.cs` задаёт W=8 lane masks.
