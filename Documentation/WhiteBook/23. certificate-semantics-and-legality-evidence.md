...
- This chapter closes the certificate/evidence explanation for the current legality documentation contour, but the wider machine-state tuple and cycle-step relation live in `Documentation/operational-semantics.md`.
