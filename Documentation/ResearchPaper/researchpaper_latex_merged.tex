...
% --- МАГИЧЕСКИЙ БЛОК ДЛЯ РАСТЯГИВАНИЯ ШАПКИ НА 2 КОЛОНКИ ---
\twocolumn[
...
% Обоснование, почему мы уходим от OoO: энергопотребление и уязвимости.
...
% Идеологическая база вашего StreamEngine (отделение вычислений от выборок).
