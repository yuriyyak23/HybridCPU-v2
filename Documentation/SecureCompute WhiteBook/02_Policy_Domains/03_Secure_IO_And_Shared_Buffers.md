...
Secure hypercall recognition does not establish VMCALL authority. Current backend-success requests fail closed. Phase 13 must define a neutral hypercall backend owner before any execution implementation can be considered.
