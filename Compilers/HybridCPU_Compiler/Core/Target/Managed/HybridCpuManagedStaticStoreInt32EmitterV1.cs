...
public static class HybridCpuManagedStaticStoreInt32EmitterV1
{
    public const string Symbol = "__hybridcpu_managed_static_store_i4";
    public const string ModuleIdentity = "hybridcpu.managed-runtime.static-store-i4/v1";
    ...
    internal static HybridCpuObjectArtifactV1 EmitObject(string symbol, ulong operation)
    {
        ...
        Op(HybridCpuOpcode.SD, HybridCpuInstructionWord.NoArchReg, 2, 18, immediate: 0);
        Op(HybridCpuOpcode.SD, HybridCpuInstructionWord.NoArchReg, 2, 19, immediate: 8);
        Op(HybridCpuOpcode.ADDI, 16, 10);
        Op(HybridCpuOpcode.ADDI, 18, 11);
        Op(HybridCpuOpcode.ADDI, 19, 12);
        ...
        Op(HybridCpuOpcode.ADDI, 15, 0, immediate: 3);
