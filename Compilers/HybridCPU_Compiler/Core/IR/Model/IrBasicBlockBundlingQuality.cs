...
{
    /// <summary>
    /// Aggregate Stage 6 quality metrics for one materialized basic-block bundle stream.
    /// </summary>
    public sealed record IrBasicBlockBundlingQuality(
        int BlockId,
        int BundleCount,
        ...
        int AmbiguousBundleCount)
    {
        ...
        /// <summary>
        /// Gets the ratio of issued instructions to total physical slots across the block.
        /// </summary>
        public double SlotUtilization => BundleCount == 0 ? 0d : (double)IssuedInstructionCount / (BundleCount * HybridCpuSlotModel.SlotCount);

        /// <summary>
        /// Gets a value indicating whether any bundle in the block required scheduler-order inversion.
        /// </summary>
        ...
        /// <summary>
        /// Gets a value indicating whether the block has adjacent-bundle continuity observations.
        /// </summary>
        public bool HasCrossBundleTransitions => CrossBundleOverlappingLaneCount > 0;

        /// <summary>
        /// Gets a value indicating whether any bundle in the block kept more than one Pareto-optimal placement candidate.
        /// </summary>
