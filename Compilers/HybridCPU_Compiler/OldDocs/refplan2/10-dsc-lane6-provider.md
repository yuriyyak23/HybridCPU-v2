...
Complete. `DmaStreamComputeLane6ProductionProvider` accepts only canonical
descriptor-backed lane6 packages with ABI/reference/footprint/owner-guard
evidence and hard-pinned lane6 parity. Queue, ordering, fault, completion,
