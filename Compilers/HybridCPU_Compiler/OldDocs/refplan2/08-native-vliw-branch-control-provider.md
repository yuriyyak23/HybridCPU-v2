...
Complete. `NativeVliwBranchControlProductionProvider` is covered by
`CompilerPhase08...Tests`; branch targets and relocation facts remain
structural, while control-flow execution, commit, and retire remain runtime-owned.
