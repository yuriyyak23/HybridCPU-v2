...
Complete. `CompilerToIseParityHarness` and Phase 05 tests verify carrier
decode/re-encode, slot/lane facts, and runtime-pending bridge fields for the
implemented provider candidates. DSC facts are hard-pinned to lane6; L7
`ACCEL_SUBMIT` remains hard-pinned to lane7.
