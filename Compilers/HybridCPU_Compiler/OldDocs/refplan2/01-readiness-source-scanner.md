...
Complete. `ProductionLoweringReadinessScanner` and
`CompilerPhase01ReadinessSourceScannerTests` enforce the listed lexical
authority-boundary rules. The scanner remains a guardrail after provider
implementation; green scanner tests do not grant runtime authority.
