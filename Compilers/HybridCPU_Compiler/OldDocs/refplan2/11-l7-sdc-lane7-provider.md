...
Complete. `L7SdcLane7ProductionProvider` accepts only descriptor-backed lane7
`ACCEL_SUBMIT` packages with ABI/reference/footprint, owner-guard, submit-guard,
and token-destination structural evidence. Token lifecycle, backend protocol,
