...
Complete. `NativeVliwLoadStoreProductionProvider` preserves the explicit
memory-order/fault runtime dependency gate and is covered by
`CompilerPhase07...Tests`. It does not claim memory publication or completed
load/store effects.
