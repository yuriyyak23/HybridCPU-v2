...
Текущая документация уже поддерживает такую дисциплину: stale producer version rejected, sideband descriptor emission is not production lowering, and canonical opcodes must execute correctly with missing/default compiler metadata. 
