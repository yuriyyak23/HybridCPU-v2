namespace YAKSys_Hybrid_CPU.Arch
{
    public static partial class OpcodeRegistry
    {
        ...
        [
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.RDCYCLE, "RDCYCLE", OpcodeCategory.System, 1, InstructionFlags.None, 1, 0, InstructionClass.Csr, SerializationClass.CsrOrdered),
            ...
            // Phase 00 VMX8 freeze: operand counts remain compatibility ABI, while
            // register-role semantics are published by VmxSpecTable. VMXON keeps its
            // reserved/ignored one-operand encoding; VMREAD/VMWRITE use Rs1/Rs2
            // registers, and VMCLEAR/VMPTRLD are descriptor-pointer operations rather
            // than scalar memory side effects.
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMREAD, "VMREAD", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMWRITE, "VMWRITE", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMCLEAR, "VMCLEAR", OpcodeCategory.Privileged, 1, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMPTRLD, "VMPTRLD", OpcodeCategory.Privileged, 1, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMPTRST, "VMPTRST", OpcodeCategory.Privileged, 1, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMCALL, "VMCALL", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.INVEPT, "INVEPT", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.INVVPID, "INVVPID", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMFUNC, "VMFUNC", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMSAVEX, "VMSAVEX", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMRESTX, "VMRESTX", OpcodeCategory.Privileged, 2, InstructionFlags.Privileged, 1, 0, InstructionClass.Vmx, SerializationClass.VmxSerial),
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.ACCEL_STATUS, "ACCEL_STATUS", OpcodeCategory.System, 0, InstructionFlags.None, 1, 0, InstructionClass.System, SerializationClass.CsrOrdered),
