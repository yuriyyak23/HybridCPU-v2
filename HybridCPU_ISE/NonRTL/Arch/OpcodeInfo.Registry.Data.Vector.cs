namespace YAKSys_Hybrid_CPU.Arch
{
    public static partial class OpcodeRegistry
    {
        ...
        [
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.MTILE_LOAD, "MTILE_LOAD", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 4, 2, InstructionClass.Memory, SerializationClass.Free),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.MTILE_STORE, "MTILE_STORE", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 4, 2, InstructionClass.Memory, SerializationClass.MemoryOrdered),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.MTILE_MACC, "MTILE_MACC", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 8, 2, InstructionClass.ScalarAlu, SerializationClass.Free),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.MTRANSPOSE, "MTRANSPOSE", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 4, 2, InstructionClass.ScalarAlu, SerializationClass.Free),
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VDOT_WIDE, "VDOT.WIDE", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.Reduction | InstructionFlags.FloatingPoint | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 12, 2),

            // ========== Vector Mask Prefix Instructions ==========
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VMSBF, "VMSBF", OpcodeCategory.Comparison, 1, InstructionFlags.Vector | InstructionFlags.MaskManipulation, 1, 0),

            // ========== Vector Widen/Narrow/Convert Instructions ==========
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VZEXT, "VZEXT", OpcodeCategory.Vector, 1, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite | InstructionFlags.WidenNarrowConvert, 1, 2),

            // ========== Vector Scan/Prefix Instructions ==========
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VSCAN_SUM, "VSCAN.SUM", OpcodeCategory.Vector, 1, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite | InstructionFlags.Scan, 8, 2),
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VPERM2, "VPERM2", OpcodeCategory.Vector, 2, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.UsesImmediate | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 4, 2),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VTRANSPOSE, "VTRANSPOSE", OpcodeCategory.Vector, 1, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 4, 2),
            ...
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VSLIDE1UP, "VSLIDE1UP", OpcodeCategory.Vector, 1, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 3, 2),
            new OpcodeInfo((uint)Processor.CPU_Core.InstructionsEnum.VSLIDE1DOWN, "VSLIDE1DOWN", OpcodeCategory.Vector, 1, InstructionFlags.Vector | InstructionFlags.Maskable | InstructionFlags.MemoryRead | InstructionFlags.MemoryWrite, 3, 2),
