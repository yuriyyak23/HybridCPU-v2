...
namespace YAKSys_Hybrid_CPU.Core
{
    public static partial class InstructionRegistry
    {
        private static void RegisterVectorInstructions()
        {
            ...
            RegisterPublishedVectorDotProductWideOp((uint)Processor.CPU_Core.InstructionsEnum.VDOT_WIDE);

            RegisterPublishedVectorPermutationOp((uint)Processor.CPU_Core.InstructionsEnum.VPERMUTE);
            RegisterPublishedVectorPerm2Op((uint)Processor.CPU_Core.InstructionsEnum.VPERM2);
            RegisterPublishedVectorTransposeOp((uint)Processor.CPU_Core.InstructionsEnum.VTRANSPOSE);
            RegisterPublishedVectorPermutationOp((uint)Processor.CPU_Core.InstructionsEnum.VRGATHER);
            RegisterPublishedVectorGatherOp((uint)Processor.CPU_Core.InstructionsEnum.VGATHER);
            RegisterPublishedVectorScatterOp((uint)Processor.CPU_Core.InstructionsEnum.VSCATTER);
            ...
            RegisterPublishedVectorSlideOneUpOp((uint)Processor.CPU_Core.InstructionsEnum.VSLIDE1UP);
            RegisterPublishedVectorSlideOneDownOp((uint)Processor.CPU_Core.InstructionsEnum.VSLIDE1DOWN);
            ...
            RegisterPublishedVectorMaskOp((uint)Processor.CPU_Core.InstructionsEnum.VMSBF);
            RegisterPublishedVectorMaskPopCountOp((uint)Processor.CPU_Core.InstructionsEnum.VPOPC);
            RegisterPublishedVectorZeroExtendOp((uint)Processor.CPU_Core.InstructionsEnum.VZEXT);
            RegisterPublishedVectorScanSumOp((uint)Processor.CPU_Core.InstructionsEnum.VSCAN_SUM);
