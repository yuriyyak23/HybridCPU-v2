...
{
    // Runtime-side fence coordinator for Phase 08. ACCEL_FENCE reaches this
    // path only through the lane7 SystemSingleton runtime, never through a
    // backend/fallback direct publication shortcut.
