...
namespace YAKSys_Hybrid_CPU.Core.Execution.DmaStreamCompute
{
    public static partial class DmaStreamComputeDescriptorParser
    {
        ...
        public static bool ExecutionEnabled => true;

        internal const string ExecutionDisabledProjectionMessage =
            "DmaStreamComputeMicroOp execution is enabled only for the Phase 06 DSC1 contour; " +
            "unsupported descriptor shapes and operations still fail closed without StreamEngine or DMAController fallback.";
