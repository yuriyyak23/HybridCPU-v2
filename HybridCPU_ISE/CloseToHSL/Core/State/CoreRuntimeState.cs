...
internal sealed class CoreRuntimeState
{
    internal CoreRuntimeState()
    {
        ...
        CpuInstructionTranslation = new CpuInstructionTranslationState();
        CompatibilityControlPolicy = new CompatibilityControlPolicyState();
    ...
    internal CpuInstructionTranslationState CpuInstructionTranslation { get; }

    internal CompatibilityControlPolicyState CompatibilityControlPolicy { get; }
