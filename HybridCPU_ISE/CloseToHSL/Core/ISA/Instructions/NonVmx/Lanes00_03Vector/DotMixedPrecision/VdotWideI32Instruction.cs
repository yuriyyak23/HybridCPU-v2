...
public sealed partial class VdotWideI32Instruction
{
    public const string Mnemonic = "VDOT.WIDE.I32";
    public const string OperandShape = "dot operands, i32 wide contour sideband";
    public const string EvidenceBoundary = "VectorDotMatrixDeferredNoExecution";
    public const string WiderIntegerContourPolicy = "i32 wide-dot contour is separate from scoped VDOT.WIDE and requires explicit integer widening, accumulator, VLM, retire/replay, and golden evidence.";
