namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.DotMixedPrecision;

public sealed partial class VdotBlockscaleInstruction
{
    public const string Mnemonic = "VDOT.BLOCKSCALE";
    public const string OperandShape = "dot operands, scale metadata sideband, accumulator/result sideband";
    public const string EvidenceBoundary = "VectorDotMatrixDeferredNoExecution";
    public const string DotAbiPolicy = "block-scaled dot requires explicit scale metadata ABI, accumulator precision, result footprint, VLM contour, staged publication, replay, and golden artifacts.";
    ...
    public const bool RequiresScaleMetadataAbi = true;
