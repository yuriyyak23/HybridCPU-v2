...
public sealed partial class VwmulInstruction
{
    public const string Mnemonic = "VWMUL";
    ...
    public const string SignednessPolicy = "Unresolved; signed widening multiply policy required";
