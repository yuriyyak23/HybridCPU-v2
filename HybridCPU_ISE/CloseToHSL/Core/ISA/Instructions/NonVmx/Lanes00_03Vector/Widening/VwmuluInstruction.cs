...
public sealed partial class VwmuluInstruction
{
    public const string Mnemonic = "VWMULU";
    public const string OperandShape = "DestSrc1Pointer, Src2Pointer, unsigned source/destination width sideband";
    ...
    public const string SignednessPolicy = "Unresolved; unsigned widening multiply policy required";
    public const string OverflowPublicationPolicy = "Unresolved; widening product/result footprint policy required";
