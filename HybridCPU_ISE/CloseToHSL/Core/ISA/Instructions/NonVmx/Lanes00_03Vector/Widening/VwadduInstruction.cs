...
public sealed partial class VwadduInstruction
{
    public const string Mnemonic = "VWADDU";
    ...
    public const string SignednessPolicy = "Unresolved; unsigned widening add policy required";
