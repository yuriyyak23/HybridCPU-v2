...
public sealed partial class VwaddInstruction
{
    public const string Mnemonic = "VWADD";
    ...
    public const string SignednessPolicy = "Unresolved; signed widening add policy required";
