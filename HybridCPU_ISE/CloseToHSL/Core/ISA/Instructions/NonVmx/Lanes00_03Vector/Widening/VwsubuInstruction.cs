...
public sealed partial class VwsubuInstruction
{
    public const string Mnemonic = "VWSUBU";
    ...
    public const string SignednessPolicy = "Unresolved; unsigned widening subtract policy required";
