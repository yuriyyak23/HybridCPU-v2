namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.Widening;

public sealed partial class VwmaccInstruction
{
    public const string Mnemonic = "VWMACC";
    public const string OperandShape = "DestSrc1Pointer, Src2Pointer, accumulator/source-width sideband";
    ...
    public const string SignednessPolicy = "Unresolved; widening multiply-accumulate signedness policy required";
    public const string AccumulatorFootprintPolicy = "Unresolved; accumulator precision and destination footprint ABI required";
    public const string OverflowPublicationPolicy = "Unresolved; widening MACC overflow/result footprint policy required";
    ...
    public const bool RequiresAccumulatorAbi = true;
