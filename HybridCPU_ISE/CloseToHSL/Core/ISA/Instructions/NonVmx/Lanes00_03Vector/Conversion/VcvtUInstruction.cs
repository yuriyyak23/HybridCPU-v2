namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.Conversion;

public sealed partial class VcvtUInstruction
{
    public const string Mnemonic = "VCVT.U";
    public const string OperandShape = "DestSrc1Pointer, unsigned integer conversion/rounding sideband";
    ...
    public const string ResultFootprintPolicy = "Unresolved; unsigned integer result footprint ABI required";
    public const string NanPolicy = "Unresolved; NaN and invalid conversion policy required";
