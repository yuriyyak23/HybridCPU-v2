...
public sealed partial class VcvtIInstruction
{
    public const string Mnemonic = "VCVT.I";
    public const string OperandShape = "DestSrc1Pointer, signed integer conversion/rounding sideband";
    ...
    public const string ResultFootprintPolicy = "Unresolved; signed integer result footprint ABI required";
