namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.Narrowing;

public sealed partial class VnsraInstruction
{
    public const string Mnemonic = "VNSRA";
    public const string OperandShape = "DestSrc1Pointer, arithmetic shift source/immediate sideband, narrowing policy sideband";
    ...
    public const string ShiftOperandPolicy = "Unresolved; arithmetic shift source/immediate ABI required";
