namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.StructureMovement;

public sealed partial class VinterleaveInstruction
{
    public const string Mnemonic = "VINTERLEAVE";
