...
public sealed partial class VavgInstruction
{
    public const string Mnemonic = "VAVG";
    public const string OperandShape = "DestSrc1Pointer, Src2Pointer, average policy sideband";
    public const string EvidenceBoundary = "VectorFixedPointSaturatingFailClosed";
    public const string AveragePolicy = "fixed-point average requires explicit signedness, element width, truncation/rounding, overflow, mask/tail, and staged publication policy.";
