...
public sealed partial class VsubSatInstruction
{
    public const string Mnemonic = "VSUB.SAT";
    ...
    public const string SaturationPolicy = "saturating subtract requires explicit signedness, element width, clamp range, overflow, mask/tail, and staged publication policy.";
