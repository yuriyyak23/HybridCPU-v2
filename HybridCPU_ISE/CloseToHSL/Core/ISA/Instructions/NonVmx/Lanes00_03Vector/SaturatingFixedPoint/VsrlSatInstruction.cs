namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.SaturatingFixedPoint;

public sealed partial class VsrlSatInstruction
{
    public const string Mnemonic = "VSRL.SAT";
    ...
    public const string SaturationPolicy = "saturating logical right shift requires an explicit meaningfulness decision plus shift operand, signedness, element width, clamp, mask/tail, and staged publication policy.";
    public const string ShiftMeaningPolicy = "logical right-shift saturation may remain reserved if the policy is non-meaningful.";
