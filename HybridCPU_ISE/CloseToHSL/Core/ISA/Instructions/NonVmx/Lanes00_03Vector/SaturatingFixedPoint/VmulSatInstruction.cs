...
public sealed partial class VmulSatInstruction
{
    public const string Mnemonic = "VMUL.SAT";
    public const string OperandShape = "DestSrc1Pointer, Src2Pointer, saturating policy sideband";
    public const string EvidenceBoundary = "VectorFixedPointSaturatingFailClosed";
    public const string SaturationPolicy = "saturating multiply requires explicit signedness, element width, product precision, clamp range, overflow, mask/tail, and staged publication policy.";
