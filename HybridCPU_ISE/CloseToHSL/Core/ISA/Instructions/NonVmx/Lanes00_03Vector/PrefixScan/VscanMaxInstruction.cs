namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.PrefixScan;

public sealed partial class VscanMaxInstruction
{
    public const string Mnemonic = "VSCAN.MAX";
    ...
    public const string ScanPolicy = "prefix max requires explicit inclusive/exclusive policy, element ordering, signedness/element type, tail behavior, replay determinism, and staged publication.";
