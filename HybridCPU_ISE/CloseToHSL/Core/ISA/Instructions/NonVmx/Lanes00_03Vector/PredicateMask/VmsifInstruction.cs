...
public sealed partial class VmsifInstruction
{
    public const string Mnemonic = "VMSIF";
    ...
    public const string PrefixSuffixMaskSemanticsPolicy = "Unresolved; including-first semantics require explicit predicate publication ABI";
