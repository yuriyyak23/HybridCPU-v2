namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Vector.PredicateMask;

public sealed partial class VfirstInstruction
{
    public const string Mnemonic = "VFIRST";
    ...
    public const string EmptyMaskResultPolicy = "Unresolved; no-active-bit sentinel ABI required";
    public const string FirstIndexWidthSignPolicy = "Unresolved; first-index width and sign policy required";
    ...
    public const bool RequiresFirstIndexWidthSignPolicy = true;
