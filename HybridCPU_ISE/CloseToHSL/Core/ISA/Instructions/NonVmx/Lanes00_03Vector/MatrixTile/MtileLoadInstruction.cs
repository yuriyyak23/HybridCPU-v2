...
public sealed partial class MtileLoadInstruction
{
    public const string Mnemonic = "MTILE_LOAD";
    ...
    public const string TileMemoryPolicy = "tile load requires explicit tile descriptor ABI, memory-shape/fault model, generic runtime ownership, staged publication, replay, and golden artifacts.";
