...
public sealed partial class MtileMaccInstruction
{
    public const string Mnemonic = "MTILE_MACC";
    public const string OperandShape = "tile descriptors, accumulator tile sideband";
    public const string EvidenceBoundary = "MatrixTileRuntimeExecutableAuthority";
    public const string TileExecutionPolicy = "tile MACC requires explicit tile descriptor ABI, accumulator tile/result footprint, execution model, staged publication, replay, and golden artifacts.";
    ...
    public const bool RequiresAccumulatorTileAbi = true;
