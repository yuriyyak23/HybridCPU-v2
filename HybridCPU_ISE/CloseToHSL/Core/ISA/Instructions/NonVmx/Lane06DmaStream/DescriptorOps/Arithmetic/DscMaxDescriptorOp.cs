namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lane06DmaStream.DescriptorOps.Arithmetic;

public sealed partial class DscMaxDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.MAX";
    public const string OperandShape = "descriptor src0/src1/dst ranges, type, shape, signedness, owner-domain sideband";
    ...
    public const bool RequiresSignednessTypePolicyAbi = true;
