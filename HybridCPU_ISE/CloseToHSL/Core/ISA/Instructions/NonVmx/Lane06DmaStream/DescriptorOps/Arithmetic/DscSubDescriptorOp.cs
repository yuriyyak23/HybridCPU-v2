...
public sealed partial class DscSubDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.SUB";
    public const string OperandShape = "descriptor src0/src1/dst ranges, type, shape, owner-domain sideband";
    ...
    public const bool RequiresArithmeticPolicyAbi = true;
