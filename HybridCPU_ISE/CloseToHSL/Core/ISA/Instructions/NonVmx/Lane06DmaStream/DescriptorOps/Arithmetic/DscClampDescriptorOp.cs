...
public sealed partial class DscClampDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.CLAMP";
    public const string OperandShape = "descriptor src/dst ranges, type, shape, bounds policy, owner-domain sideband";
    ...
    public const bool RequiresBoundsPolicyAbi = true;
