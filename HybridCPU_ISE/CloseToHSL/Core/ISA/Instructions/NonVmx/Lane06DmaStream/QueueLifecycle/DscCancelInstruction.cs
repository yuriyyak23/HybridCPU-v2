// DSC_CANCEL metadata anchor: Lane6 queue cancellation remains deferred until
// cancel scope, token/queue authority, retire side effects, and rollback evidence close.
...
public sealed partial class DscCancelInstruction
{
    public const string Mnemonic = "DSC_CANCEL";
    public const string OperandShape = "QueueTokenOrHandle, cancel scope sideband";
    public const string ParameterDescriptor = "TokenOrQueueHandle, cancel scope, affected token/queue sideband";
    public const string MicroOpShape = "Lane6QueueControl.Cancel, queue-authority gated, retire-owned cancellation side effect";
