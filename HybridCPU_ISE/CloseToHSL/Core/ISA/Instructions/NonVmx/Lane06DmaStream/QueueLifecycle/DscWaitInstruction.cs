// DSC_WAIT metadata anchor: Lane6 queue wait remains deferred until wait scope,
// token/queue authority, retire publication, and replay evidence close.
...
public sealed partial class DscWaitInstruction
{
    public const string Mnemonic = "DSC_WAIT";
    public const string OperandShape = "QueueTokenOrHandle, wait scope sideband";
    public const string ParameterDescriptor = "TokenOrQueueHandle, wait/fence scope, optional timeout or policy sideband";
    public const string MicroOpShape = "Lane6QueueControl.Wait, queue-authority gated, retire-owned wait completion";
