// DSC_POLL metadata anchor: Lane6 queue observation remains deferred until
// token/queue authority, decoder ABI, retire publication, and replay evidence close.
...
public sealed partial class DscPollInstruction
{
    public const string Mnemonic = "DSC_POLL";
    public const string OperandShape = "QueueTokenOrHandle, status destination sideband";
    public const string ParameterDescriptor = "TokenOrQueueHandle, optional queue scope, retire-visible status result";
    public const string MicroOpShape = "Lane6QueueControl.Poll, queue-authority gated, retire-owned status publication";
