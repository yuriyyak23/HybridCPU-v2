...
// MINU production metadata anchor: scalar unsigned min is runtime-owned by the scalar ALU evidence chain.
...
{
    public const string Mnemonic = "MINU";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "DestRegister, SourceRegister1, SourceRegister2, XLEN=64 unsigned comparison sideband";
    public const string MicroOpShape = "ScalarBinaryAlu.MinUnsigned, retire-owned register writeback, no flags";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string Signedness = "Unsigned";

    public const int XLen = 64;

    public const bool RequiresSignednessAbi = false;
    public const bool UsesUnsignedComparison = true;
    ...
    public static ushort Opcode => (ushort)YAKSys_Hybrid_CPU.Processor.CPU_Core.InstructionsEnum.MINU;
