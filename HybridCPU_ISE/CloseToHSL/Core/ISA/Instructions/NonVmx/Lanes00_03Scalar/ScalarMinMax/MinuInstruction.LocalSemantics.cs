namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.ScalarMinMax;

public sealed partial class MinuInstruction
{
    public const bool LocalSemanticsAvailable = true;
    public const bool LocalGoldenSeedAvailable = true;
    public const string LocalOpcodeGate = "Opcode 329 is allocated in the scalar extension block.";
    ...
    public const string LocalMaterializerGate = "Registry publishes ScalarALUMicroOp for MINU with register-register operands.";
    public const string LocalMicroOpGate = "InternalOpBuilder maps MINU to typed InternalOpKind.MinU.";
    public const string LocalExecuteGate = "Runtime Execute and ScalarAluOps share XLEN=64 unsigned min semantics.";
    ...
    public const string LocalCompilerGate = "Compiler helper emission remains closed; no MINU helper authority is opened.";
    ...
    [
        ...
        new(0xFFFF_FFFF_FFFF_FFFFUL, 0x0000_0000_0000_0001UL, 0x0000_0000_0000_0001UL),
        new(0x8000_0000_0000_0000UL, 0x7FFF_FFFF_FFFF_FFFFUL, 0x7FFF_FFFF_FFFF_FFFFUL),
    ];
