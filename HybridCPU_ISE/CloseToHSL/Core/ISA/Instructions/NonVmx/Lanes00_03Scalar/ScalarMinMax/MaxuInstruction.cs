...
// MAXU production metadata anchor: scalar unsigned max is runtime-owned by the scalar ALU evidence chain.
...
{
    public const string Mnemonic = "MAXU";
    ...
    public const string MicroOpShape = "ScalarBinaryAlu.MaxUnsigned, retire-owned register writeback, no flags";
    ...
    public static ushort Opcode => (ushort)YAKSys_Hybrid_CPU.Processor.CPU_Core.InstructionsEnum.MAXU;
