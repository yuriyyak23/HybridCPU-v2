...
{
    public const string Mnemonic = "MIN";
    ...
    public const string MicroOpShape = "ScalarBinaryAlu.MinSigned, retire-owned register writeback, no flags";
    ...
    public static ushort Opcode => (ushort)YAKSys_Hybrid_CPU.Processor.CPU_Core.InstructionsEnum.MIN;
