...
public sealed partial class MaxInstruction
{
    ...
    public const string LocalOpcodeGate = "Opcode 328 is allocated in the scalar extension block.";
    ...
    public const string LocalMaterializerGate = "Registry publishes ScalarALUMicroOp for MAX with register-register operands.";
    public const string LocalMicroOpGate = "InternalOpBuilder maps MAX to typed InternalOpKind.Max.";
    public const string LocalExecuteGate = "Runtime Execute and ScalarAluOps share XLEN=64 signed max semantics.";
    ...
    public const string LocalCompilerGate = "Compiler helper emission remains closed; no MAX helper authority is opened.";
