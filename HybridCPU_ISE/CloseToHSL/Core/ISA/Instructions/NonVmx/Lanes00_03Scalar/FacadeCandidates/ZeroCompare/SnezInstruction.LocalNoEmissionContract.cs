namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.FacadeCandidates.ZeroCompare;

public sealed partial class SnezInstruction
{
    public const bool LocalNoEmissionContractAvailable = true;
    public const bool LocalHardwareCandidateGoldenSeedAvailable = true;
    public const string LocalOpcodeGate = "Phase 01F selects facade-only/no-emission; no SNEZ opcode is allocated.";
    public const string LocalDecoderGate = "No SNEZ decoder row is published; hardware form would need a future full scalar path.";
    public const string LocalInstructionIrGate = "No SNEZ IR projection is published; facade policy is not runtime evidence.";
    public const string LocalMaterializerGate = "No SNEZ materializer row is published.";
    public const string LocalMicroOpGate = "No SNEZ runtime MicroOp is published.";
    ...
    [
        ...
        new(0x0000_0000_0000_0001UL, 0x0000_0000_0000_0001UL),
        new(0xFFFF_FFFF_FFFF_FFFFUL, 0x0000_0000_0000_0001UL),
        new(0x8000_0000_0000_0000UL, 0x0000_0000_0000_0001UL),
    ];
