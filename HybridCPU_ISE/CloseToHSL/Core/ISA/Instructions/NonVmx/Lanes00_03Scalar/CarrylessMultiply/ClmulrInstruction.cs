...
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.CarrylessMultiply;

public sealed partial class ClmulrInstruction
{
    public const string Mnemonic = "CLMULR";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "rd receives carry-less product bits [126:63] for XLEN=64";
    public const string MicroOpShape = "ScalarCarryLessMultiply.ReversedHighWindow, retire-owned register writeback, no flags";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string BitOrderPolicy = "Bit index 0 is the least-significant bit; reversed/high window starts at product bit XLEN-1.";
    public const string Operation = "carryless_product(rs1, rs2) >> 63";

    public const int XLen = 64;
    public const int ProductWindowStartBit = 63;
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.CLMULR;
    ...
    public static CarryLessGoldenVector[] GetLocalGoldenVectors() =>
        new CarryLessGoldenVector[]
        {
            ...
            new CarryLessGoldenVector(0xFFFF_FFFF_FFFF_FFFFUL, 0xFFFF_FFFF_FFFF_FFFFUL, 0xAAAA_AAAA_AAAA_AAAAUL),
            new CarryLessGoldenVector(0x8000_0000_0000_0000UL, 0x0000_0000_0000_0002UL, 0x0000_0000_0000_0002UL),
            new CarryLessGoldenVector(0x1234_5678_9ABC_DEF0UL, 0x0FED_CBA9_8765_4321UL, 0x01C0_71B0_D110_A160UL),
        };
