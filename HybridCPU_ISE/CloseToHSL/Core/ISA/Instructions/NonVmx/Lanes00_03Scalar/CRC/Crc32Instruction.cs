// CRC32 is a scalar CRC negative-decision gate: no opcode/materializer/helper authority
// until polynomial/reflection/seed/final-xor/endian ABI is explicit. VMX stays generic.
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.CRC;

public sealed partial class Crc32Instruction
{
    public const string Mnemonic = "CRC32";
    public const string OperandShape = "rd, rs_seed, rs_data";
    public const string ParameterDescriptor = "rd receives a 32-bit CRC result once polynomial/reflection ABI is frozen";
    ...
    public const string PolynomialPolicy = "Unspecified: CRC32 does not imply IEEE, Castagnoli, Koopman, or any other polynomial.";
