...
public sealed partial class Sh3addInstruction
{
    public const string Mnemonic = "SH3ADD";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "rd receives rs2 + (rs1 << 3) under XLEN=64 scalar ALU rules";
    public const string MicroOpShape = "ScalarBinaryAlu.AddressGenerationShiftLeftThreeAdd, retire-owned register writeback, no LSU bypass";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string Operation = "(rs1 << 3) + rs2";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.SH3ADD;
    ...
    public static AddressGenerationGoldenVector[] GetLocalGoldenVectors() =>
        new AddressGenerationGoldenVector[]
        {
            ...
            new AddressGenerationGoldenVector(1UL, 2UL, 10UL),
            new AddressGenerationGoldenVector(0x2000_0000_0000_0000UL, 5UL, 5UL),
            new AddressGenerationGoldenVector(ulong.MaxValue, 9UL, 1UL),
        };
