...
public sealed partial class Sh2addUwInstruction
{
    public const string Mnemonic = "SH2ADD.UW";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "rd receives rs2 + (zero-extend32(rs1) << 2) under XLEN=64 scalar ALU rules";
    public const string MicroOpShape = "ScalarBinaryAlu.AddressGenerationShiftLeftTwoAddUnsignedWord, retire-owned register writeback, no LSU bypass";
    ...
    public const string Operation = "(zero_extend_64(low32(rs1)) << 2) + rs2";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.SH2ADD_UW;
    ...
    public static ulong Execute(ulong source, ulong addend) =>
        unchecked(((ulong)(uint)source << 2) + addend);
    ...
    public static AddressGenerationGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new AddressGenerationGoldenVector(0xFFFF_FFFF_0000_0001UL, 2UL, 6UL),
            new AddressGenerationGoldenVector(0xFFFF_FFFF_FFFF_FFFFUL, 1UL, 0x3_FFFF_FFFDUL),
            new AddressGenerationGoldenVector(0x0000_0000_8000_0000UL, 0UL, 0x2_0000_0000UL),
            new AddressGenerationGoldenVector(0x0000_0000_FFFF_FFFFUL, ulong.MaxValue, 0x3_FFFF_FFFBUL),
        };
