...
// explicit .UW source-width ABI zero-extends low 32 bits of rs1 before add; InstructionIR/projector;
...
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.AddressGeneration;

public sealed partial class AddUwInstruction
{
    public const string Mnemonic = "ADD.UW";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "rd receives rs2 + zero-extend32(rs1) under XLEN=64 scalar ALU rules";
    public const string MicroOpShape = "ScalarBinaryAlu.AddressGenerationAddUnsignedWord, retire-owned register writeback, no LSU bypass";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string SourceWidthPolicy = "Zero-extend low 32 bits of rs1 before add; rs2 remains full XLEN=64.";
    public const string Operation = "zero_extend_64(low32(rs1)) + rs2";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.ADD_UW;
    ...
    public static AddressGenerationGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new AddressGenerationGoldenVector(0xFFFF_FFFF_0000_0001UL, 2UL, 3UL),
            new AddressGenerationGoldenVector(0xFFFF_FFFF_FFFF_FFFFUL, 1UL, 0x1_0000_0000UL),
            new AddressGenerationGoldenVector(0x0000_0000_8000_0000UL, 0UL, 0x8000_0000UL),
            new AddressGenerationGoldenVector(0x0000_0000_FFFF_FFFFUL, ulong.MaxValue, 0xFFFF_FFFEUL),
        };
