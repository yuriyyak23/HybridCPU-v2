...
public sealed partial class BsetInstruction
{
    public const string Mnemonic = "BSET";
    ...
    public const string MicroOpShape = "ScalarBinaryAlu.BitSetRegisterIndex, retire-owned register writeback, no flags";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.BSET;
    ...
    public static BitfieldGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new BitfieldGoldenVector(0x0000_0000_0000_0000UL, 0, 0x0000_0000_0000_0001UL),
            new BitfieldGoldenVector(0x0000_0000_0000_0000UL, 63, 0x8000_0000_0000_0000UL),
            new BitfieldGoldenVector(0x0000_0000_0000_0010UL, 4, 0x0000_0000_0000_0010UL),
            new BitfieldGoldenVector(0x0123_4567_89AB_CDEFUL, 68, 0x0123_4567_89AB_CDFFUL),
        };
