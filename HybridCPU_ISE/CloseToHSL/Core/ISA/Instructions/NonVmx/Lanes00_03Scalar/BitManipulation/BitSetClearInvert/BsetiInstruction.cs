...
public sealed partial class BsetiInstruction
{
    public const string Mnemonic = "BSETI";
    ...
    public const string MicroOpShape = "ScalarImmediateAlu.BitSetImmediateIndex, retire-owned register writeback, no flags";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.BSETI;
    ...
    public static BitfieldImmediateGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0000UL, 0, 0x0000_0000_0000_0001UL),
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0000UL, 63, 0x8000_0000_0000_0000UL),
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0010UL, 4, 0x0000_0000_0000_0010UL),
            new BitfieldImmediateGoldenVector(0x0123_4567_89AB_CDEFUL, 4, 0x0123_4567_89AB_CDFFUL),
        };
