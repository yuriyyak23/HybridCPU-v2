...
public sealed partial class BclrInstruction
{
    public const string Mnemonic = "BCLR";
    ...
    public const string MicroOpShape = "ScalarBinaryAlu.BitClearRegisterIndex, retire-owned register writeback, no flags";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.BCLR;
    ...
    public static BitfieldGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new BitfieldGoldenVector(0xFFFF_FFFF_FFFF_FFFFUL, 0, 0xFFFF_FFFF_FFFF_FFFEUL),
            new BitfieldGoldenVector(0xFFFF_FFFF_FFFF_FFFFUL, 63, 0x7FFF_FFFF_FFFF_FFFFUL),
            new BitfieldGoldenVector(0x0000_0000_0000_0010UL, 4, 0x0000_0000_0000_0000UL),
            new BitfieldGoldenVector(0x0123_4567_89AB_CDFFUL, 68, 0x0123_4567_89AB_CDEFUL),
        };
