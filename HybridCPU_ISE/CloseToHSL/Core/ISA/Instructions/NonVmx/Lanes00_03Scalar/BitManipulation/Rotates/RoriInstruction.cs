...
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.BitManipulation.Rotates;

public sealed partial class RoriInstruction
{
    public const string Mnemonic = "RORI";
    ...
    public const string MicroOpShape = "ScalarImmediateAlu.RotateRight, retire-owned register writeback, no flags";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string CompatibilityBoundary = "Register-register ROR remains separate; rotate-immediate uses canonical imm6 ABI.";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.RORI;
    ...
    public static RotateImmediateGoldenVector[] GetLocalGoldenVectors() =>
        new RotateImmediateGoldenVector[]
        {
            ...
            new RotateImmediateGoldenVector(0x0000_0000_0000_0001UL, 1, 0x8000_0000_0000_0000UL),
            new RotateImmediateGoldenVector(0x0000_0000_0000_0001UL, 63, 0x0000_0000_0000_0002UL),
            new RotateImmediateGoldenVector(0x0123_4567_89AB_CDEFUL, 4, 0xF012_3456_789A_BCDEUL),
            new RotateImmediateGoldenVector(0x8000_0000_0000_0000UL, 63, 0x0000_0000_0000_0001UL),
        };
