...
public sealed partial class OrnInstruction
{
    ...
    public const string LocalOpcodeGate = "Closed by production ORN opcode allocation.";
    ...
    public const string LocalMicroOpGate = "Closed through scalar binary ALU or-not runtime MicroOp publication.";
    public const string LocalExecuteGate = "Pure XLEN=64 rs1 | ~rs2 semantics are runtime Execute authority for ORN.";
    ...
    [
        ...
        new(0x1234_5678_9ABC_DEF0UL, 0x00FF_00FF_00FF_00FFUL, 0xFF34_FF78_FFBC_FFF0UL),
    ];
