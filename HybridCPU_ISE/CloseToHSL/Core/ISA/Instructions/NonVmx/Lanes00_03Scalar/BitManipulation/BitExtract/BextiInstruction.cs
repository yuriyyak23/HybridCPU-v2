...
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.BitManipulation.BitExtract;

public sealed partial class BextiInstruction
{
    public const string Mnemonic = "BEXTI";
    public const string OperandShape = "rd, rs1, imm6";
    public const string ParameterDescriptor = "DestRegister, SourceRegister, Immediate6, XLEN=64 bit-extract sideband";
    public const string MicroOpShape = "ScalarImmediateAlu.BitExtractImmediateIndex, retire-owned canonical 0/1 writeback, no flags";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string IndexPolicy = "Immediate index is an unsigned imm6 payload; decoder/encoder reject values outside [0, 63]; result is canonical 0 or 1.";
    public const string Operation = "(rs1 >> imm6) & 1";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.BEXTI;
    ...
    public static ulong Execute(ulong source, ulong immediate6) =>
        (source >> (int)(immediate6 & ImmediateMask)) & 1UL;
    ...
    public static BitfieldImmediateGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0001UL, 0, 1UL),
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0001UL, 1, 0UL),
            new BitfieldImmediateGoldenVector(0x8000_0000_0000_0000UL, 63, 1UL),
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0010UL, 4, 1UL),
            new BitfieldImmediateGoldenVector(0x0000_0000_0000_0000UL, 4, 0UL),
        };
