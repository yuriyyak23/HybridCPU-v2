...
namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes00_03Scalar.BitManipulation.BitSetClearInvert;

public sealed partial class BinvInstruction
{
    public const string Mnemonic = "BINV";
    public const string OperandShape = "rd, rs1, rs2";
    public const string ParameterDescriptor = "DestRegister, SourceRegister, IndexRegister, XLEN=64 bitfield sideband";
    public const string MicroOpShape = "ScalarBinaryAlu.BitInvertRegisterIndex, retire-owned register writeback, no flags";
    public const string ExecutionLaneBinding = "Lanes00_03Scalar";
    public const string EvidenceBoundary = "ExecutableScalarAlu";
    public const string IndexPolicy = "Register index is masked to XLEN=64 width with rs2 & 0x3F.";
    public const string Operation = "rs1 ^ (1UL << (rs2 & 0x3F))";
    ...
    public static ushort Opcode => (ushort)Processor.CPU_Core.InstructionsEnum.BINV;
    ...
    public static ulong Execute(ulong source, ulong index) =>
        source ^ (1UL << (int)(index & IndexMask));
    ...
    public static BitfieldGoldenVector[] GetLocalGoldenVectors() =>
        ...
        {
            new BitfieldGoldenVector(0x0000_0000_0000_0000UL, 1, 0x0000_0000_0000_0002UL),
            new BitfieldGoldenVector(0x0000_0000_0000_0002UL, 1, 0x0000_0000_0000_0000UL),
            new BitfieldGoldenVector(0x0000_0000_0000_0000UL, 63, 0x8000_0000_0000_0000UL),
            new BitfieldGoldenVector(0x0000_0000_0000_0010UL, 68, 0x0000_0000_0000_0000UL),
        };
