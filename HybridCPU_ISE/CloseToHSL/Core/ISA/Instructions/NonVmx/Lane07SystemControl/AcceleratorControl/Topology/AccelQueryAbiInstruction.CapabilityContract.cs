...
public sealed partial class AccelQueryAbiInstruction
{
    ...
    public const bool RequiresAcceleratorAbiQueryContract = true;
    public const bool RequiresBoundedCapabilityResultFootprint = true;
