namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes04_05Memory.Segments;

public sealed partial class Vstseg2Instruction
{
    public const string Mnemonic = "VSTSEG2";
    ...
    public const int SegmentCount = 2;
