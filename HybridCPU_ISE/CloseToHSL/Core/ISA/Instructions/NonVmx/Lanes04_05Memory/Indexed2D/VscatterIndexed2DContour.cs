namespace YAKSys_Hybrid_CPU.CloseToHSL.Core.ISA.Instructions.NonVmx.Lanes04_05Memory.Indexed2D;

public sealed partial class VscatterIndexed2DContour
{
    public const string Mnemonic = "VSCATTER";
    ...
    public const string AddressingContourPolicy = "base VSCATTER 1D indexed evidence does not authorize the indexed+2D contour.";
    public const string PublicationPolicy = "indexed+2D scatter requires staged byte commit after descriptor, bounds, and replay evidence close.";
