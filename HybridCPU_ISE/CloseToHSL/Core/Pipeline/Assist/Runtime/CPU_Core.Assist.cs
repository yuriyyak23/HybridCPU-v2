...
namespace YAKSys_Hybrid_CPU
{
    public partial struct Processor
    {
        public sealed partial class CPU_Core
        {
            ...
            {
                _assistRuntimeEpoch++;
                Runtime.Telemetry.AssistInvalidationCount++;
            ...
            internal bool ExecuteAssistMicroOp(Core.AssistMicroOp assistMicroOp)
            {
                ...
                try
                {
                    ...
                    {
                        Runtime.Telemetry.AssistCompletedCount++;
                    }
                    else
                    {
                        Runtime.Telemetry.AssistKilledCount++;
