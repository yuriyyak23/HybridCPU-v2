...
namespace YAKSys_Hybrid_CPU
{
    public partial struct Processor
    {
        public sealed partial class CPU_Core
        {
            ...
            /// </summary>
            // RF-08.3d: local monotonically increasing issuer for exact attempts
            // created solely by successful existing Stage-B materialization.
            /// <summary>
            ...
            {
                CancelInFlightSingleLaneControllerRequests();
                pipeIF.Clear();
                pipeID.Clear();
                pipeEX.Clear();
                pipeMEM.Clear();
                ...
                Runtime.Retire.LastRetiredBundlePc = 0;
                Runtime.Retire.RetiredBundleSequence = 0;
                ...
                Core.MicroOpScheduler scheduler =
                    pod?.Scheduler ?? _fspScheduler ?? new Core.MicroOpScheduler();
                _fspScheduler = scheduler;
                EnsureConfiguredExactProbeRuntimeProfile(scheduler);
                ...
                Core.AssistInvalidationReason assistInvalidationReason = Core.AssistInvalidationReason.PipelineFlush)
            {
                ...
                ClearPendingCpuFetchTranslationFault();
            ...
            {
                return pipeCtrl.CreateSnapshot();
            }
