...
namespace YAKSys_Hybrid_CPU
{
    public partial struct Processor
    {
        ...
        {
            public struct ScalarMemoryLaneState
            {
                ...
                public Core.PostStageBIssuedAttempt? PostStageBIssuedAttempt;
                ...
                public CpuInstructionTranslationFault? CpuTranslationFault;
                public bool DefersStoreCommitToWriteBack;
                public YAKSys_Hybrid_CPU.Memory.MemorySubsystem.MemoryRequestToken? PendingMemoryRequest;
                public MemoryRequestId? PendingMemoryControllerRequestId;
                public byte[]? PendingReadBuffer;
                ...
                public void Clear(byte laneIndex)
                {
                    ...
                    FaultAddress = 0;
                    FaultIsWrite = false;
                    CpuTranslationFault = null;
                    DefersStoreCommitToWriteBack = false;
                    PendingMemoryRequest = null;
                    PendingMemoryControllerRequestId = null;
                    // Preserve the reusable read buffer across clears so the lane can
                    // satisfy the next explicit async load without reallocating.
                }
            }
        }
    }
