...
namespace YAKSys_Hybrid_CPU.Execution
{
    internal static partial class StreamEngine
    {
        ...
        /// <summary>
        /// Check if operation is a prefix scan instruction.
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool IsScanOp(uint opCode)
        {
            return OpcodeRegistry.IsScanOp(opCode);
        }
        ...
        private static bool IsDotProductOp(uint opCode)
        {
            return opCode == (uint)Processor.CPU_Core.InstructionsEnum.VDOT ||
                   ...
                   opCode == (uint)Processor.CPU_Core.InstructionsEnum.VDOT_WIDE;
        }
