...
public sealed partial class MemoryDomainRuntime
{
    ...
    internal MemoryDomainSourceBindResult BindAuthoritativeTranslationView(
        ...
        ulong runtimeAddressSpaceTag)
    {
        InvalidateCpuSecondStageLifecycleBeforeSourceChange();
        return BindSource(descriptor, runtimeAddressSpaceTag, "bound");
    }
    ...
    {
        InvalidateCpuSecondStageLifecycleBeforeSourceChange();
        return BindSource(descriptor, runtimeAddressSpaceTag, "replaced");
    }
    ...
    {
        InvalidateCpuSecondStageLifecycleBeforeSourceChange();
        return BindSource(descriptor, runtimeAddressSpaceTag, "rebound after restore");
    }
