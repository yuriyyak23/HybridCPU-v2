...
internal sealed class VmReadScalarResultReceipt
{
    ...
    internal VmReadScalarResultReceipt(
        ...
        object sourceOwner,
        ulong sourceEpoch,
        NeutralCompletionObservationSnapshot completionObservationCapture,
        ulong profileGeneration,
        ulong attemptId,
        ulong issuerGeneration,
        ulong bundleIdentity,
        ...
        ulong value)
        : this(owner, attempt, decisionId, sourceOwner, sourceEpoch,
            executionDomainCapture: null, memoryDomainCapture: null,
            profileGeneration, attemptId, issuerGeneration, bundleIdentity,
            replayEpoch, restoreGeneration, domainTag, addressSpaceTag: 0,
            descriptorEpoch: default, field, destinationRegister, value)
    {
        CompletionObservationCapture = completionObservationCapture;
    }
    ...
    internal VmReadScalarResultReceipt(
        ...
        object sourceOwner,
        ulong sourceEpoch,
        CompatibilityControlPolicySnapshot compatibilityControlCapture,
        ulong profileGeneration,
        ulong attemptId,
        ulong issuerGeneration,
        ulong bundleIdentity,
        ...
        : this(owner, attempt, decisionId, sourceOwner, sourceEpoch,
            ...
            descriptorEpoch: default, field, destinationRegister, value)
    {
        CompatibilityControlCapture = compatibilityControlCapture;
    }
    ...
    internal NeutralCompletionObservationSnapshot? CompletionObservationCapture { get; }
    internal CompatibilityControlPolicySnapshot? CompatibilityControlCapture { get; }
