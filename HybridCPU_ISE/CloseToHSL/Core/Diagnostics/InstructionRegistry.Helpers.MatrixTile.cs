...
namespace YAKSys_Hybrid_CPU.Core
{
    public static partial class InstructionRegistry
    {
        ...
        private static void RegisterMatrixTileMicroOp(uint opCode)
        {
            RegisterSemanticFactory(opCode, ctx =>
            {
                ...
                MatrixTileMicroOp microOp =
                    MatrixTileIrProjectionAndMaterializer.CreateTypedMicroOp(materializedInstruction);
            ...
            InstructionsEnum opcode)
        {
            ...
            {
                MatrixTileNumericPolicy = ctx.MatrixTileNumericPolicy,
                MatrixTileLayoutPolicy = ctx.MatrixTileLayoutPolicy
            };
        }
