    ...
    public partial struct Processor
    {
        public sealed partial class CPU_Core
        {
            public enum InstructionsEnum : ushort
            {
                ...
                SLL = 47, // ShiftLeftLogical
                SRL = 48, // ShiftRightLogical
                ...
                // ═══════════════════════════════════════════════════
                // Non-VMX CloseToHSL Iteration 03A: scalar bitmanip CTZ.
                // ═══════════════════════════════════════════════════
                ...
                // ═══════════════════════════════════════════════════
                // Non-VMX CloseToHSL Iteration 03B: scalar byte/half extension.
                // ═══════════════════════════════════════════════════
                ...
                // ═══════════════════════════════════════════════════
                // Non-VMX CloseToHSL Iteration 03C: scalar rotates.
                // ═══════════════════════════════════════════════════
                ...
                // ═══════════════════════════════════════════════════
                // Non-VMX CloseToHSL Phase 01: scalar boolean-invert.
                // ═══════════════════════════════════════════════════
                ...
                // Non-VMX CloseToHSL Phase 01C: scalar min/max.
                ...
                // Non-VMX CloseToHSL Phase 01D: scalar byte/bit reverse.
                ...
                // Non-VMX CloseToHSL Phase 01E: scalar zeroing select.
                /// <summary>Conditional zero if rs2 != 0: rd = (rs2 != 0) ? 0 : rs1</summary>
                CZERO_NEZ = 333,

                // Non-VMX CloseToHSL Phase 01A closure: canonical scalar popcount.
                /// <summary>Population count over XLEN=64: rd = popcount(rs1)</summary>
                CPOP = 334,

                // Non-VMX CloseToHSL Phase 02: scalar rotate-immediate.
                /// <summary>Rotate left by imm6: rd = rol(rs1, imm6)</summary>
                ROLI = 335,
                /// <summary>Rotate right by imm6: rd = ror(rs1, imm6)</summary>
                RORI = 336,

                // Non-VMX CloseToHSL Phase 02: scalar register-indexed bitfield.
                ...
                // Non-VMX CloseToHSL Phase 02: scalar immediate-indexed bitfield.
                ...
                // Non-VMX CloseToHSL Phase 03: scalar address-generation and .UW.
                ...
                // Non-VMX CloseToHSL Phase 04: scalar carry-less high/reversed windows.
            ...
            public static class IsaOpcodeValues
            {
                ...
                public const ushort ADD = (ushort)InstructionsEnum.ADD;
                public const ushort SUB = (ushort)InstructionsEnum.SUB;
                public const ushort MUL = (ushort)InstructionsEnum.MUL;
                public const ushort DIV = (ushort)InstructionsEnum.DIV;
                public const ushort SLL = (ushort)InstructionsEnum.SLL;
                public const ushort SRL = (ushort)InstructionsEnum.SRL;
