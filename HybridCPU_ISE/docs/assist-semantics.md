...
| lane-6 stream-register pressure | `AssistBackpressureRejectKind.DmaStreamRegisterFile` | `AssistBackpressureRejects`, `AssistBackpressureDmaSrfRejects`, `TypedSlotAssistBackpressureRejects`, `TypedSlotRejectReason.AssistBackpressureReject` | Lane6/DMA assist could not allocate assist-owned SFR space without evicting foreground-owned registers. |
