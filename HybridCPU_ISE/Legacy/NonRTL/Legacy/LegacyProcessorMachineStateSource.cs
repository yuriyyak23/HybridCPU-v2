...
namespace HybridCPU_ISE.Legacy
{
    ...
    public sealed class LegacyProcessorMachineStateSource : IIseMachineStateSource
    {
        ...
        public int GetCoreCount()
        {
            ...
            {
                if (cores[coreIndex].ArchContexts == null ||
                    cores[coreIndex].ArchContexts.Length != Processor.CPU_Core.SmtWays)
                {
                    break;
                }
        ...
        public CpuCoreDiagnosticSnapshot GetCoreSnapshot(int coreId) => Processor.GetCoreSnapshot(coreId);
        ...
        public TypedSlotTelemetryProfile? GetTypedSlotTelemetryProfile(int coreId, string programHash)
        {
            ...
            return TelemetryExporter.BuildProfile(
                scheduler,
                programHash,
                GetCoreSnapshot(coreId).GetPipelineControl());
        }
