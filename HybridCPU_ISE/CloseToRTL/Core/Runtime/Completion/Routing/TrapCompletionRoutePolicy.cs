...
public readonly record struct TrapCompletionRouteRequest(
    ...
    ulong FaultAux = 0,
    EvidenceVisibilityClass CompletionEvidenceClass =
        EvidenceVisibilityClass.HostOwnedRuntimeEvidence,
    TrapCompletionMigrationClass CompletionMigrationClass =
...
public sealed class TrapCompletionRouteService
{
    ...
    public TrapCompletionPublicationFenceResult EvaluateFence(
        ...
        TrapCompletionPublicationFence.Default.Evaluate(
            ...
            request.FaultAux,
            request.CompletionEvidenceClass,
            request.CompletionMigrationClass);
}
