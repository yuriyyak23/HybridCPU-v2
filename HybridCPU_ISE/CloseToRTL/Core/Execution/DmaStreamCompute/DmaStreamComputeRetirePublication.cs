...
namespace YAKSys_Hybrid_CPU.Core.Execution.DmaStreamCompute
{
    ...
    public enum DmaStreamComputeRetirePublicationSurfaceKind : byte
    {
        ...
        ProductionLane6RuntimeRetire = 1
    }
    ...
    public sealed record DmaStreamComputeRetireObservation
    {
        public DmaStreamComputeRetireObservation(
            ...
            DmaStreamComputeRetirePublicationSurfaceKind surfaceKind =
        ...
        public DmaStreamComputeRetirePublicationSurfaceKind SurfaceKind { get; }

        public bool IsExplicitFuturePublicationSurface =>
            SurfaceKind == DmaStreamComputeRetirePublicationSurfaceKind.ExplicitTestFutureSeam;

        public bool IsNormalPipelineExecutableLane6Path =>
            SurfaceKind == DmaStreamComputeRetirePublicationSurfaceKind.ProductionLane6RuntimeRetire;
    ...
    public static class DmaStreamComputeRetirePublication
    {
        ...
        public static DmaStreamComputeRetireObservation ObserveProductionRetire(
            DmaStreamComputeActiveTokenEntry entry,
            ulong architecturalInstructionAge,
            int ownerThreadId = -1,
            ulong completionCycle = 0)
        ...
        private static DmaStreamComputeRetireObservation ObserveRetire(
            DmaStreamComputeActiveTokenEntry entry,
            ulong architecturalInstructionAge,
            int ownerThreadId,
            ulong completionCycle,
