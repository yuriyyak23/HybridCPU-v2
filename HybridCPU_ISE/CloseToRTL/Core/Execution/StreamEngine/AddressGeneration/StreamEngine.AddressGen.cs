...
namespace YAKSys_Hybrid_CPU.Execution
{
    ...
    internal static class AddressGen
    {
        ...
        public static bool IsWideningOpcode(uint opCode)
        {
            ...
            // Hardware-level decision: VDOT_FP8 widens from 1-byte to 4-byte,
            // VDOT.WIDE widens FP16/BF16 inputs from 2-byte elements to one FP32 scalar.
            return op == Processor.CPU_Core.InstructionsEnum.VDOT_FP8 ||
                   op == Processor.CPU_Core.InstructionsEnum.VDOT_WIDE;
        }
