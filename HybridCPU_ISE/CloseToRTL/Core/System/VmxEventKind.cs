...
namespace YAKSys_Hybrid_CPU.Core
{
    ...
    internal enum VmxEventKind : byte
    {
        ...
        /// <summary>Descriptor-owned intercept produced a VM-exit.</summary>
        InterceptExit,

        /// <summary>Root queued an event for virtual guest injection.</summary>
        EventQueued,

        /// <summary>Pending virtual event was delivered into guest state.</summary>
        EventDelivered,

        /// <summary>Root-owned VMX preemption timer expired.</summary>
