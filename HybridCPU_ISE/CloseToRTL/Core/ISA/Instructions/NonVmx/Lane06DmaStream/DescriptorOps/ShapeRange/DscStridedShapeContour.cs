...
public sealed partial class DscStridedShapeContour
{
    public const string Mnemonic = "DSC_SHAPE_STRIDED";
    public const string OperandShape = "strided descriptor shape sideband";
    ...
    public const bool RequiresStrideAbi = true;
