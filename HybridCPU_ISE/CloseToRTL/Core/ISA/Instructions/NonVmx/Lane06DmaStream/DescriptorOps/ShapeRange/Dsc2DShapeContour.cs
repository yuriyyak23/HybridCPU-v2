...
public sealed partial class Dsc2DShapeContour
{
    public const string Mnemonic = "DSC_SHAPE_2D";
    public const string OperandShape = "2D descriptor shape sideband";
    ...
    public const bool Requires2DShapeAbi = true;
