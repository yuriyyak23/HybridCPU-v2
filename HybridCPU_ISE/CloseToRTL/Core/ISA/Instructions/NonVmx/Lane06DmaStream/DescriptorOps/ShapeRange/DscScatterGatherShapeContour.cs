...
public sealed partial class DscScatterGatherShapeContour
{
    public const string Mnemonic = "DSC_SHAPE_SCATTER_GATHER";
    public const string OperandShape = "scatter/gather descriptor shape and index-surface sideband";
