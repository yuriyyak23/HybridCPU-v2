...
public sealed partial class DscCompareDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.COMPARE";
    public const string OperandShape = "descriptor compare operands, predicate footprint, type/shape/owner-domain sideband";
