...
public sealed partial class DscReduceSumDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.REDUCE_SUM";
    public const string OperandShape = "descriptor reduction range, type/shape, scalar or surface result footprint";
