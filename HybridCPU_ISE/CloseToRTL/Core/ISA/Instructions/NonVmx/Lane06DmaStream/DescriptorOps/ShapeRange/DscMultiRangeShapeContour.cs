namespace YAKSys_Hybrid_CPU.CloseToRTL.Core.ISA.Instructions.NonVmx.Lane06DmaStream.DescriptorOps.ShapeRange;

public sealed partial class DscMultiRangeShapeContour
{
    public const string Mnemonic = "DSC_SHAPE_MULTI_RANGE";
    public const string OperandShape = "multi-range descriptor shape sideband";
    public const string EvidenceBoundary = "Lane6ShapeContourNoExecution";
    public const string ExecutionLaneBinding = "Lane06DmaStream";
    public const string ShapeAuthorityBoundary = "GenericLane6DescriptorRuntimeOnly";
    ...
    public const bool RequiresShapeEnumAllocation = true;
    ...
    public const bool RequiresShapeParserManifest = true;
    ...
    public const bool RequiresShapeFaultModel = true;
    public const bool RequiresAliasOverlapPolicy = true;
    public const bool RequiresMultiRangeAbi = true;
    public const bool RequiresNormalizedFootprintAbi = true;
    public const bool RequiresPartialCompletionPolicy = true;
    ...
    public const bool NoShapeEnumPublication = true;
    public const bool NoDescriptorParserPublication = true;
