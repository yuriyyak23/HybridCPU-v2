...
public sealed partial class DscReduceAndDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.REDUCE_AND";
    public const string OperandShape = "descriptor reduction range, integer type/shape, scalar or surface result footprint";
