...
public sealed partial class DscTiledShapeContour
{
    public const string Mnemonic = "DSC_SHAPE_TILED";
    public const string OperandShape = "tiled descriptor shape sideband";
    ...
    public const bool RequiresTileShapeAbi = true;
