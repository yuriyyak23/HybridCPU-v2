namespace YAKSys_Hybrid_CPU.CloseToRTL.Core.ISA.Instructions.NonVmx.Lane06DmaStream.DescriptorOps.Reduction;

public sealed partial class DscReduceMaxDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.REDUCE_MAX";
    public const string OperandShape = "descriptor reduction range, signedness/type/shape, scalar or surface result footprint";
    ...
    public const bool RequiresReductionResultFootprintAbi = true;
    public const bool RequiresScalarOrSurfaceResultPolicy = true;
