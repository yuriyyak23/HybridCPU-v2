namespace YAKSys_Hybrid_CPU.CloseToRTL.Core.ISA.Instructions.NonVmx.Lane06DmaStream.DescriptorOps.TypeConversion;

public sealed partial class DscConvertDescriptorOp
{
    public const string Mnemonic = "DmaStreamCompute.CONVERT";
    public const string OperandShape = "descriptor src/dst ranges, source/destination type, conversion policy, owner-domain sideband";
