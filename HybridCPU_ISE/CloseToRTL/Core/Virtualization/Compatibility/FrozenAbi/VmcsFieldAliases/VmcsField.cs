...
namespace YAKSys_Hybrid_CPU.Core
{
    ...
    /// Phase 00 freezes every current id as a VMX8 compatibility alias. These
    /// aliases remain valid when VMCSv2 descriptors are introduced, but they do
    /// not freeze any unfrozen VMX-v2 draft layout.
    /// </summary>
