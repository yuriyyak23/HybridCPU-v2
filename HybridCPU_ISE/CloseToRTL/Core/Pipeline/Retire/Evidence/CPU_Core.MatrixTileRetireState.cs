...
namespace YAKSys_Hybrid_CPU
{
    public partial struct Processor
    {
        public partial struct CPU_Core
        {
            ...
            private ulong _matrixTileReplayInvalidationEpoch;
            ...
            internal ulong GetMatrixTileReplayInvalidationEpoch()
            {
                if (_matrixTileReplayInvalidationEpoch == 0)
                {
                    _matrixTileReplayInvalidationEpoch = 1;
                }

                return _matrixTileReplayInvalidationEpoch;
            }

            internal ulong AdvanceMatrixTileReplayInvalidationEpochForTesting()
            {
                ulong current = GetMatrixTileReplayInvalidationEpoch();
                _matrixTileReplayInvalidationEpoch = checked(current + 1);
                return _matrixTileReplayInvalidationEpoch;
            }
