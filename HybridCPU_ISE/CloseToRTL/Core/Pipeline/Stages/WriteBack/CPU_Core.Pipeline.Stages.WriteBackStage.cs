...
namespace YAKSys_Hybrid_CPU
{
    public partial struct Processor
    {
        ...
        {
            /// <summary>
            /// Pipeline stage for write-back
            /// </summary>
            public struct WriteBackStage
            {
                public bool Valid;
                public byte ActiveLaneIndex;
                public ScalarWriteBackLaneState Lane0;
                public ScalarWriteBackLaneState Lane1;
                public ScalarWriteBackLaneState Lane2;
                public ScalarWriteBackLaneState Lane3;
                public ScalarWriteBackLaneState Lane4;
                public ScalarWriteBackLaneState Lane5;
                public ScalarWriteBackLaneState Lane6;
                public ScalarWriteBackLaneState Lane7;
                ...
                public ScalarWriteBackLaneState GetLane(byte laneIndex) =>
                    PipelineLaneResolver.ResolveLaneOrThrow(laneIndex, nameof(WriteBackStage)) switch
                {
                    0 => Lane0,
                    1 => Lane1,
                    2 => Lane2,
                    ...
                    6 => Lane6,
                    7 => Lane7,
                    _ => throw new InvalidPipelineLaneException(nameof(WriteBackStage), laneIndex)
                };

                public void SetLane(byte laneIndex, ScalarWriteBackLaneState lane)
                {
                    switch (PipelineLaneResolver.ResolveLaneOrThrow(laneIndex, nameof(WriteBackStage)))
                    {
                        case 0:
                            Lane0 = lane;
                            break;
                ...
                {
                    ScalarWriteBackLaneState lane = GetLane(laneIndex);
                    lane.PC = value;
